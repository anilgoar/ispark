       ...
       if(!empty($processArr))
        ...
        if($this->request->is('Post'))
        {
            ...
            if(!empty($this->request->data))
            {
                ...
                $arrayMonth = array('01'=>'Jan','1'=>'Jan','02'=>'Feb','2'=>'Feb','03'=>'Mar','3'=>'Mar','04'=>'Apr','05'=>'May','06'=>'Jun','07'=>'Jul','08'=>'Aug','09'=>'Sep','10'=>'Oct','11'=>'Nov','12'=>'Dec');
                $MntArr = explode("-",date("Y-m-d"));
                $FinanceYear =  $MntArr[0];
                $FinanceMonth =  $arrayMonth[$MntArr[1]]; 
                if(in_array($FinanceMonth,array('1','2','3','01','02','03')))
                {
