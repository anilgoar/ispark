...
'0' TDS,'0' `AdvDed`,
IF(t1.ESIS='Yes',CEIL((CEIL(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.HRA/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Conv/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.OthAllw/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Gross/$pred*t2.ArrerDays)+0+IFNULL(t3.incamt,0)+CEIL(t1.Gross/$d*t2.OT))/100*1.75),'0') ESI,
((Round(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.HRA/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Conv/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.OthAllw/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Gross/$pred*t2.ArrerDays)+0+IFNULL(t3.incamt,0)+CEIL(t1.Gross/$d*t2.OT))-ROUND(ROUND(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))/100*12)-IF(t1.ESIS='Yes',CEIL((CEIL(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.HRA/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Conv/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.OthAllw/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Gross/$pred*t2.ArrerDays)+0+IFNULL(t3.incamt,0)+CEIL(t1.Gross/$d*t2.OT))/100*1.75),'0')) NetPay,
Round(Round(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))/100*13.16) EPF,
IF(t1.ESIS='Yes',CEIL((CEIL(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.HRA/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Conv/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.OthAllw/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Gross/$pred*t2.ArrerDays)+0+IFNULL(t3.incamt,0)+CEIL(t1.Gross/$d*t2.OT))/100*4.75),'0') EESI,
IF(t1.Dept='VODAFONE PNG','335','120') EmplrIns,
((ROUND(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.HRA/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Conv/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.OthAllw/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Gross/$pred*t2.ArrerDays)+0+IFNULL(t3.incamt,0)+CEIL(t1.Gross/$d*t2.OT))+Round(Round(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))/100*13.16)+IF(t1.ESIS='Yes',CEIL((CEIL(t1.Basic/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.HRA/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Conv/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.OthAllw/$d*(t2.Present+t2.WO+t2.Holiday+t2.HalfDay+t2.Compoff+t2.EL+t2.CL+t2.SL))+CEIL(t1.Gross/$pred*t2.ArrerDays)+0+IFNULL(t3.incamt,0)+CEIL(t1.Gross/$d*t2.OT))/100*4.75),'0')+IF(t1.Dept='VODAFONE PNG','335','120')) CTC
...
$target_file = $target_dir . basename($this->request->data['upload']['file']['name']);
	...
	$this->layout = "home";
      ...
      if($this->request->is("post"))  
      {
        ...
        $month = $result['month'];
           //echo ; exit;
           $data = $this->Leave->query("SELECT EmpCode,SUM(PL) pl,SUM(CL) cl,SUM(SL) sl FROM qual_leave t1 WHERE LeaveStatus='CR' GROUP BY EmpCode");
		   ...
		   foreach($data as $d)
		   {
		   	$data1 = $this->Leave->query("SELECT EmpCode,SUM(PL) pl,SUM(CL) cl,SUM(SL) sl FROM qual_leave t2 WHERE EmpCode='".$d['t1']['EmpCode']."' and LeaveStatus='DR'");
			
			  echo "<tr>";	
			  echo "<td>".$d['t1']['EmpCode']."</td>";
			  echo "<td>".($d['0']['pl']-$data1[0]['0']['pl'])."</td>";
			  echo "<td>".($d['0']['cl']-$data1[0]['0']['cl'])."</td>";
			  echo "<td>".($d['0']['sl']-$data1[0]['0']['sl'])."</td>"; 
			  echo "</tr>"; 
		   }
		  //t1.,t1.,t1.PFS
		   echo "</table>";
