            ...
            <table border="1"  >     
                ...
                -->
                    ...
                    <?php 
                        ...
                        if($ESIElig =="YES"){
                        $ESIC               =   round($Gross1*1.75/100);
                        $ESICCompany        =   ceil($Gross1*4.75/100);
                        }
                        else{
                        $ESIC               =   0; 
                        $ESICCompany        =   0;  
                        ...
                        $LoanEndDate        =   "$y-$m-01";     
                        $LoanArr            =   $this->LoanMaster->find('first',array('fields'=>array('Id','Amount','DeductionPerMonth','DeductedAmount','PendingAmount','LastUpdateDate'),'conditions'=>array('BranchName'=>$BranchName,'EmpCode'=>$EmpCode,'DATE(EndDate) >='=>$LoanEndDate,'TransationStatus'=>'YES','ApproveFirst'=>'Yes','ApproveSecond'=>'Yes','Type'=>'Loan')));
                        $AdvaArr            =   $this->LoanMaster->find('first',array('fields'=>array('Id','Amount','DeductionPerMonth','DeductedAmount','PendingAmount','LastUpdateDate'),'conditions'=>array('BranchName'=>$BranchName,'EmpCode'=>$EmpCode,'DATE(EndDate) >='=>$LoanEndDate,'TransationStatus'=>'YES','ApproveFirst'=>'Yes','ApproveSecond'=>'Yes','Type'=>'Advance')));
