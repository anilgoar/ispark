<?php
class JoinemployeeExportsController extends AppController {
    ...
    public function show_report(){
        ...
        if(isset($_REQUEST['BranchName']) && $_REQUEST['BranchName'] !=""){
            ...
            $conditoin=array('Status'=>1,'MONTH(DOJ)'=>$_REQUEST['EmpMonth'],'YEAR(DOJ)'=>$_REQUEST['EmpYear'],'EmpCode !='=>'');
                ...
                <table class = "table table-striped table-hover  responstable"  >     
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;width: 60px;">EmpCode</th>
                            <th>EmpName</th>
                ...
                <thead>
                    ...
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td><?php echo $val['Masjclrentry']['Mobile'];?></td>
