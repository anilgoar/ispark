...
class ReportsController extends AppController 
{
    ...
    public function beforeFilter()
    {
        ...
        {   $role=$this->Session->read("role");
            ...
            if(in_array('22',$roles)){$this->Auth->allow('report','get_type','get_report','get_report2','get_report3','get_report4','ptp','get_report6','get_report6a','view');}
            if(in_array('23',$roles)){$this->Auth->allow('report','get_type','get_report','get_report2','bill_genrate_report','get_report3','get_report4','ptp','get_report6','get_report6a','view');}
        }
    }
...
//      WHERE t1.status = '0' and bpp.bill_no is null $query order by t1.finance_year, CONVERT (SUBSTRING_INDEX(t1.bill_no,'/','1'),UNSIGNED INT) "; exit;
        $this->set("res",$this->InitialInvoice->query("SELECT t1.id,t1.createdate, t3.ExpDatesPayment,t2.company_name,t2.cost_center,t2.CostCenterName,t2.client,
