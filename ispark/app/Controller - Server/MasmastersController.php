...
{
    public $uses = array('Addbranch','User','maspackage','masband','Masjclrentry','MasJclrMaster','BandNameMaster');
    ...
    public function beforeFilter()
    {
        ...
        else
        {
            ...
            $this->Auth->allow('index','get_design','editpackage','uploadattend','exportsalary','get_design','incentive','get_status_data','typeformat','importformat','salaryslip','exportincentive','salaryprocess','Savefile','showfile','discardsalary','discardincentive','salarybreakup','get_salary','updatesalary');
