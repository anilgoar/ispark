...
class AccountValidationsController extends AppController {
    ...
    public function viewdetails(){
        ...
        if($this->request->is('Post')){
            ...
            $updArr=array(
                'EmpName'=>"'".$this->request->data['AccHolder']."'",
                'AccHolder'=>"'".$this->request->data['AccHolder']."'",
                'AcBank'=>"'".$this->request->data['AcBank']."'",
                'AcBranch'=>"'".$this->request->data['AcBranch']."'",
                'AcNo'=>"'".$this->request->data['AcNo']."'",
                'IFSCCode'=>"'".$this->request->data['IFSCCode']."'",
                'AccType'=>"'".$this->request->data['AccType']."'",
                'AcRejectionRemarks'=>"'".$this->request->data['AcRejectionRemarks']."'",
                'AcValidationDate'=>"'".date('Y-m-d H:i:s')."'",
                'AcValidatedBy'=>"'".$AuthId."'",
                'AcValidationStatus'=>"'".$Status."'",
            );
