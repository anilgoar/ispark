		...
		public function beforeFilter()
		{
			...
			$this->Auth->allow('get_collection_data','index');
                                    ...
                                    $this->Auth->allow('index','get_bill_remark','get_branch','getCostCenter','get_budget','add_field_value',
                                            ...
                                            'edit_grn_tmp_branch','save_grn_tmp1_branch','view_grn','view_grn_tmp','view_imprest','view_imprest_tmp','get_due_date','approve_grn2','approve_grn_tmp2','approve_imprest2','approve_imprest_tmp2','vendorstatuscode');
			...
			else
			{
				...
				//$roles=explode(',',$rdx['Access']['page_access']);
                            ...
                            if(in_array('68',$roles))
                            {
                                    ...
                                    $this->Auth->allow('back');
                                    $this->Auth->allow('add'); 
                                    $this->Auth->allow('index','get_bill_remark','get_branch','getCostCenter','get_budget','add_field_value','add_grn_tmp','delete_grn','get_head','get_sub_heading','imprest_entry','get_sub_heading1','imprest_add','pending_grn','vendorstatuscode');
                            }
			}			
