<?php
class LeftemployeeExportsController extends AppController {
    ...
    public function show_report(){
        ...
        if(isset($_REQUEST['BranchName']) && $_REQUEST['BranchName'] !=""){
            ...
            $conditoin=array('Status'=>0,'MONTH(ResignationDate)'=>$_REQUEST['EmpMonth'],'YEAR(ResignationDate)'=>$_REQUEST['EmpYear']);
                ...
                <table class = "table table-striped table-hover  responstable"  >     
                    ...
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;"><?php echo $val['Masjclrentry']['Dept'];?></td>
    ...
    public function export_report(){
        ...
        if(isset($_REQUEST['BranchName']) && $_REQUEST['BranchName'] !=""){
            ...
            header("Content-Disposition: attachment; filename=LeftEmployeeExport.xls");
                ...
                <thead>
                    ...
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $val['Masjclrentry']['BranchName'];?></td>
                            <td style="text-align: center;"><?php echo $val['Masjclrentry']['CostCenter'];?></td>
                             <td style="text-align: center;"><?php echo $val['Masjclrentry']['Mobile'];?></td>
                            <td style="text-align: center;"><?php echo date('d-M-Y',strtotime($val['Masjclrentry']['DOJ']));?></td>
                            <td style="text-align: center;"><?php echo date('d-M-Y',strtotime($val['Masjclrentry']['ResignationDate']));?></td>
                            <td style="text-align: center;"><?php echo $val['Masjclrentry']['LeftReason'];?></td>
                            <td style="text-align: center;"><?php echo $val['Masjclrentry']['Source'];?></td>
                            <td style="text-align: center;"><?php echo $val['Masjclrentry']['SourceType'];?></td>
