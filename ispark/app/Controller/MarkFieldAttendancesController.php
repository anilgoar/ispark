...
class MarkFieldAttendancesController extends AppController {
    ...
    public function markfield(){
        ...
        $dt2=$this->FieldAttendanceMaster->find('list',array('fields'=>array('Attanddate'),'conditions'=>array('BranchName'=>$branchName,'CostCenter'=>$CostCenter,'Attanddate !='=>'','date(Attanddate) >'=>'2019-11-31'),'group' =>array('Attanddate')));
        $dt3=  array_diff($dt1, $dt2);
        */
        
        $month  =   date('m', strtotime(date('Y-m')." -1 month"));
        $years  =   date('Y', strtotime(date('Y-m')." -1 month"));
        $dt1    =   $this->Masattandance->find('list',array('fields'=>array('Attanddate'),'conditions'=>array('Attanddate !='=>'','month(Attanddate)'=>$month,'year(Attanddate)'=>$years),'group' =>array('Attanddate')));
        $dt2    =   $this->FieldAttendanceMaster->find('list',array('fields'=>array('Attanddate'),'conditions'=>array('BranchName'=>$branchName,'CostCenter'=>$CostCenter,'Attanddate !='=>'','month(Attanddate)'=>$month,'year(Attanddate)'=>$years),'group' =>array('Attanddate')));
        $dt3    =  array_diff($dt1, $dt2);
