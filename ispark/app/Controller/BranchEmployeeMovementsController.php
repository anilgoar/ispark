    	...
    	public function index() 
        {
            ...
            if($this->request->is('POST'))
            {
                ...
                else if(!empty($this->request->data['submit']) && $this->request->data['submit']=='Move')
                {
                    ...
                    $Emp_Arr    =   $this->Masjclrentry->find('first',array('fields'=>array('EmpCode','BranchName','CostCenter'),'conditions'=>array('EmpCode'=>$EmpCode)));
                    $Emp_Row    =   $Emp_Arr['Masjclrentry'];
                    
                    $EmployeeMove['EmpCode']=$Emp_Row['EmpCode'];
                    $EmployeeMove['FromBranch']=$Emp_Row['BranchName'];
                    $EmployeeMove['FromCostCenter']=$Emp_Row['CostCenter'];
                    ...
                    else
                    {
                        ...
                        if($this->EmployeeMove->save($EmployeeMove))
                        {
                            ...
                            //$UpdAtten = "Update Attandence set BranchName='$ToBranch',CostCenter='$cost_center' Where EmpCode='$EmpCode' $monthYear";
                            $UpdAtten = "Update Attandence set BranchName='$ToBranch',CostCenter='$cost_center' Where EmpCode='$EmpCode'";
                            $UpdBranchMoveRsc = $this->Masjclrentry->query($UpdBranchMove);
                            $UpAttendRsc = $this->Masattandance->query($UpdAtten);
                            
                            $this->Masjclrentry->query("UPDATE `FieldAttandence` SET BranchName='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `OnSiteAttendance` SET BranchName='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `leave_management` SET BranchName='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `LoanMaster` SET BranchName='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `upload_incentive_breakup` SET BranchName='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `upload_deduction` SET BranchName='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `salary_data` SET Branch='$ToBranch',CostCenter='$cost_center' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `BranchWiseAttandanceIssue` SET BranchName='$ToBranch' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `IncomtaxMaster` SET BranchName='$ToBranch' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `od_apply_master` SET BranchName='$ToBranch' WHERE EmpCode='$EmpCode'");
                            $this->Masjclrentry->query("UPDATE `od_apply_master_history` SET BranchName='$ToBranch' WHERE EmpCode='$EmpCode'");
