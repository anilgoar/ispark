	...
	class AddclientsController extends AppController 
	{
	   ...
	   public function add() 
	   {
        	if ($this->request->is('post')) 
			{
				...
				{
                                    $client_id = $this->Addclient->getLastInsertID();;
                                    $part_name = $this->request->data['client_name']; 
                                $this->Addclient->query("INSERT INTO `tbl_voucher_entries` SET entry_type='client',part_id='$client_id',part_name='$part_name',createdate=NOW()");
