<?php
class WorkHomeAttendanceExportsController extends AppController {
    public $uses = array('Addbranch','Masjclrentry','Masattandance','FieldAttendanceMaster','OnSiteAttendanceMaster','HolidayMaster','WorkHomeAttandenceMaster');
    ...
    public function index(){
        ...
        $this->set('branchName',array('NOIDA-2'=>'NOIDA-2'));
            ...
            <div class="col-sm-12" style="overflow-y:scroll;" >
                <table class = "table table-striped table-hover  responstable"  >     
                    ...
                    <tbody>         
                        ...
                        $val['Masjclrentry']['EmpLocation'] ="Field";
                        ...
                        if($val['Masjclrentry']['EmpLocation'] =="InHouse"){
                            ...
                            $AttArr   =   $this->WorkHomeAttandenceMaster->find('list',array('fields'=>array('AttandDate','Status'),'conditions'=>$conditoin1));
                        }
                        ...
                        <tr>
                            ...
                            <td><?php echo $val['Masjclrentry']['Profile'];?></td>
                            <td><?php echo $val['Masjclrentry']['CostCenter'];?></td>
                            <td>OnSite</td>
                            <td><?php echo $val['Masjclrentry']['Billable_Status'];?></td>
                            <?php
                            $OLS=0;
                            $A=0;
                            $P=0;
                            ...
                            $AttandMonth    =   $_REQUEST['EmpMonth']."-".$_REQUEST['EmpYear'];
                            $whac           =   $this->WorkHomeAttandenceMaster->query("SELECT * FROM WorkHomeAttandenceCalculation WHERE EmpCode='{$val['Masjclrentry']['EmpCode']}' AND AttandMonth='$AttandMonth';"); 
                            if(empty($whac)){
                                $this->WorkHomeAttandenceMaster->query("INSERT INTO `WorkHomeAttandenceCalculation` SET EmpCode='{$val['Masjclrentry']['EmpCode']}',EmpName='{$val['Masjclrentry']['EmpName']}',BranchName='{$val['Masjclrentry']['BranchName']}',CostCenter='{$val['Masjclrentry']['CostCenter']}',TotalDays='$Total',AttandMonth='$AttandMonth';"); 
                            }else{
                                $this->WorkHomeAttandenceMaster->query("UPDATE `WorkHomeAttandenceCalculation` SET EmpCode='{$val['Masjclrentry']['EmpCode']}',EmpName='{$val['Masjclrentry']['EmpName']}',BranchName='{$val['Masjclrentry']['BranchName']}',CostCenter='{$val['Masjclrentry']['CostCenter']}',TotalDays='$Total',AttandMonth='$AttandMonth' WHERE EmpCode='{$val['Masjclrentry']['EmpCode']}' AND AttandMonth='$AttandMonth';"); 
                            }
    ...
    public function getcostcenter(){
        if(isset($_REQUEST['BranchName']) && $_REQUEST['BranchName'] !=""){
            ...
            if(!empty($data)){
                echo "<option value='BSS/BO/NOIDA-2/576'>BSS/BO/NOIDA-2/576</option>";
                /*
