...
class UsersController extends AppController {
    ...
    {
        parent::beforeFilter();
        $this->Auth->allow('add','view','assign_Access','view_access','edit_User','add_date','getMessage','getMessageDisplay','updateMessage','user_array','puser_array','change_password','get_emp','sendmail','getcostcenter');
