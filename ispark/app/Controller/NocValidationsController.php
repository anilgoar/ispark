<?php
class NocValidationsController extends AppController {
    ...
    public function index(){
        ...
        if($this->request->is('Post')){ 
            $branch_name    =   $this->request->data['NocValidations']['branch_name'];
            ...
            $conditoin=array('Status'=>0,'FnfStatus'=>'Upload');
            ...
            if(!empty($data)){
                ...
                //$conditoin=array('Status'=>0,'FnfStatus'=>'Reject');
                $conditoin['FnfStatus']="Reject";
                $data   =   $this->Masjclrentry->find('all',array('conditions'=>$conditoin)); 
                $this->set('data',$data); 
            }  
        }  
    ...
    public function viewdetails(){
        ...
        if($this->request->is('Post')){
            ...
            $updArr=array(
                'NocValidateRemarks'=>"'".$this->request->data['NocValidateRemarks']."'",
                'NocValidateDate'=>"'".date('Y-m-d H:i:s')."'",
                'NocValidateBy'=>"'".$AuthId."'",
                'FnfStatus'=>"'".$Status."'",
            );
