<?php
	...
	{
		public $uses=array('Collection','CollectionAdvance','Addbranch','BillMaster','TMPCollection','Addcompany','TMPCollectionParticulars',
    ...
    //			}
		...
		public function get_bill_remark()
		{
			...
			else if($data = $this->InitialInvoice->find('first',array('fields'=>array('invoiceDescription'),'conditions'=>array("SUBSTRING_INDEX(bill_no,'/','1')"=>$result['bill_no'],'branch_name' => $result['branch_name'],'finance_year' => $result['finance_year']))))
			{
                ...
                public function index() 
		{
			...
			$this->set('bank_master',$this->Bank->find('all',array('fields'=>array('bank_name'))));
                        ...
                        $advance_id = $this->params->query['advance_id'];
                        if(!empty($advance_id))
                        {
                            $data = $this->CollectionAdvance->find('first',array('conditions'=>array('id'=>$advance_id)));
                            $tmp_advance = $data['CollectionAdvance'];
                            $tmp_advance['username'] =  $username;
                            //print_r($tmp_advance);exit;
                            $this->TMPCollection->deleteAll(array('username'=>$username));
                            $this->TMPCollection->save($tmp_advance);
                            $data = array_values($data['CollectionAdvance']);
                            $this->set('payment_master',$data);
                            $this->set('advance_id',$advance_id);
                        }
			else if($data = $this->TMPCollection->find('first',array('conditions'=>array('username'=>$username))))
			{
			...
			{ 
				...
				{ 
                    ...
                    if(strval($total) != strval($checkTotal))
                    {
                            ...
                            return $this->redirect(array('controller'=>'Collections','action' => 'index',"?"=>array("Id"=>$advance_id)));
                    }
					...
					$this->OtherTMPDeduction->deleteAll(array('username'=>$username));
                                        ...
                                        if(!empty($advance_id))
                                        {
                                            $this->CollectionAdvance->deleteAll(array('id'=>$advance_id));
                                            $this->CollectionBillAdvance->deleteAll(array('collection_id'=>$advance_id));
                                        }
                ...
                public function delete_bill_other_deduction()
		{
			...
			$this->set('result',$id = $this->params->query);
                ...
                public function view_payment()
                {
                    ...
                    $this->set('Data2',$this->CollectionAdvance->find('all',array('order'=>array('id'=>'desc'))));
                }
                ...
                public function edit_payment1()
                {
                    ...
                    $this->set('result3',$this->OtherBillTMPDeduction->find('all',array('conditions'=>array('username'=>$username,'status'=>'0'))));
                    $this->set('bank_master',$this->Bank->find('all',array('fields'=>array('bank_name'))));
                    $this->set('finance_yearNew',$this->BillMaster->find('list',array('fields'=>array('finance_year','finance_year'),'conditions'=>array('finance_year'=>array('2021-22','2022-23','2023-24')))));
                ...
                public function edit_advance()
                {
                    ...
                    $this->set('bank_master',$this->Bank->find('all',array('fields'=>array('bank_name'))));
                    $this->set('finance_yearNew',$this->BillMaster->find('list',array('fields'=>array('finance_year','finance_year'),'conditions'=>array('finance_year'=>'2017-18'))));
                    if($data = $this->CollectionAdvance->find('first',array('conditions'=>array('Id'=>$Id))))
                    {
                        $data = array_values($data['CollectionAdvance']);
