    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('NocValidations',array('action'=>'index','class'=>'form-horizontal')); ?>
                            ...
                            <tbody>         
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php $this->webroot;?>NocValidations/viewdetails?EJEID=<?php echo $EJEID;?>">View</a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>   
