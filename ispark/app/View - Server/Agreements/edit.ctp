...
{
    $.post("get_costcenter",{branch_name:val},function(data)
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
		...
		<h4 class="page-header"><?php echo $this->Session->flash(); ?></h4>
                ...
                'image_upload'=>'Image Upload','download'=>'Download');
                ...
                for($i=0; $i<count($keys); $i++)
                {
                    ...
                    else if($keys[$i]=='cost_center')
                    {
                        ...
                        explode(',',$cost_center3),'multiple'=>true,'required'=>true,'onClick'=>"write_costcenter()",'class'=>'form-control'));
                        echo "</div></div>";
                    }
                    ...
                    else if($keys[$i]=='download')
                    {
                        ...
                        foreach($files as $f)
                        {
                            echo '<a href="'.$this->webroot.'app/webroot/Agreement/'.$data['Id'].'/'.$f.'">'.$f."</a><br>";
                        }
                        echo "</div>";
                    }
		...
		<i class="fa fa-times"></i>
            ...
            <div class="box-content">
                ...
                for($i=0; $i<count($keys); $i++)
                {
                    ...
                    echo '<div class="col-sm-3">';
                    $str = explode('.',$keys[$i]);
                    echo $this->Form->textArea($keys[$i],array('label'=>false,'value'=>$esc1['Escalation'][$str[1]],'required'=>$flag,'class'=>'form-control'));
                    echo "</div>";   
                    if($i%2==1)
                    {
                        echo '</div>';
		...
		<i class="fa fa-times"></i>
            ...
            <div class="box-content">
                ...
                for($i=0; $i<count($keys); $i++)
                {
                    ...
                    echo '<div class="col-sm-3">';
                    $str = explode('.',$keys[$i]);
                    echo $this->Form->textArea($keys[$i],array('label'=>false,'value'=>$esc2['Escalation'][$str[1]],'required'=>$flag,'class'=>'form-control'));
                    echo "</div>";   
		...
		<i class="fa fa-times"></i>
            ...
            <div class="box-content">
                ...
                for($i=0; $i<count($keys); $i++)
                {
                    ...
                    echo '<div class="col-sm-3">';
                    $str = explode('.',$keys[$i]);
                    echo $this->Form->textArea($keys[$i],array('label'=>false,'value'=>$esc3['Escalation'][$str[1]],'required'=>$flag,'class'=>'form-control'));
                    echo "</div>";   
