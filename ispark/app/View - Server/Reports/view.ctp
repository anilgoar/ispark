...
<?php $this->Form->create('Add',array('controller'=>'AddInvParticular','action'=>'view')); ?>
	...
	<div class="form-group has-success has-feedback">
		...
		<label class="col-sm-2 control-label"><b style="font-size:14px"> Select Company </b></label>	
			...
			<div class="col-sm-2">
            <div id ="mm">
				<?php	echo $this->Form->input('branch_name', array('label'=>false,'options'=>$data,'empty'=>'Select Company','class'=>'form-control','onChange'=>'get_report5(this.value')); ?>
                </div>
			</div>			
		...
		<div class="form-group">
			<div class="col-sm-2">
				<button class="btn btn-info btn-label-left" value = "show" onClick="report_validate1();">Show</button>
			</div>
			<div class="col-sm-2">
				<button class="btn btn-info btn-label-left" onClick="report_new();">Export</button>
			</div>
		</div>
