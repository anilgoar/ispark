			...
			<div class="box">
				<div class="box-content">
					...
					<div class="form-group">
						...
						<?php echo $this->Form->input('branch_name',array('label'=>false,'options'=>$data,'class'=>'form-control','empty'=>'Select Branch','id'=>'BranchName','required'=>true)); ?>
					</div>
                                        <div class="form-group">
                                            <label class="control-label">Emp Code</label>
                                            <input type="text" class="form-control" placeholder="Emp Code" onkeyup="search_employees(this.value)" >
					</div>
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input('hr_eligible',array('label'=>false,'class'=>'form-control','options'=>array('Yes'=>'Yes','No'=>'No'),'empty'=>'Select')); ?>
					</div>
					<div class="form-group">
