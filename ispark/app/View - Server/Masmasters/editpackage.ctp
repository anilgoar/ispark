 ...
 function grossAmount(){
  ...
  if(document.getElementById('Medical').value=='')
   ...
   if(document.getElementById('OtherAllow').value=='')
    ...
    if(gross <= 21000)
    {
        var esico = Math.round(gross*4.75/100);
    var ecsic =  Math.round(gross*1.75/100);
    }
    else
    {
        var esico =0;
...
<div class="box-content" >
    ...
    <?php echo $this->Form->create('maspackage',array('class'=>'form-horizontal')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                <?php echo $this->Form->input('BranchName',array('label' => false,'options'=>$branchName,'value'=>$Jclr[0]['maspackage']['BranchName'],'empty'=>'Select','class'=>'form-control','id'=>'BranchName','onchange'=>'getBranch(this.value)','required'=>true)); ?>
            </div>    
        </div> 
    </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                <?php	echo $this->Form->input('Band', array('label'=>false,'options'=>$band,'required'=>true,'value'=>$Jclr[0]['maspackage']['Band'],'empty'=>'select','class'=>'form-control','onchange'=>'Design(this.value)')); ?>
            </div>    
        </div>
        ...
        <div class="col-sm-3">
            <div class="input-group">
                <?php	echo $this->Form->input('PackageAmount', array('label'=>false,'placeholder'=>'Package','value'=>$Jclr[0]['maspackage']['PackageAmount'],'id'=>'PackageAmount','required'=>true,'onKeyPress'=>'return checkNumber(this.value,event)')); ?>
            </div>    
        </div>
         </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                <?php echo $this->Form->input('Basic',array('label' => false,'id'=>'Basic','value'=>$Jclr[0]['maspackage']['Basic'], 'oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
            </div>    
        </div>
        ...
        <div class="col-sm-2" >
           <?php echo $this->Form->input('Conveyance',array('label' => false,'id'=>'Conveyance','value'=>$Jclr[0]['maspackage']['Conveyance'],'placeholder'=>'Conveyance' ,'oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Portfolio', array('label'=>false,'type'=>'text','value'=>$Jclr[0]['maspackage']['Portfolio'],'placeholder'=>'Portfolio','id'=>'Portfolio','oninput'=>'grossAmount(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>      
        </div>
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('Medical', array('label'=>false,'value'=>$Jclr[0]['maspackage']['Medical'],'placeholder'=>'Medical Allowance','id'=>'Medical','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('Special', array('label'=>false,'value'=>$Jclr[0]['maspackage']['Special'],'placeholder'=>'Special Allowance','id'=>'Special','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('OtherAllow', array('label'=>false,'value'=>$Jclr[0]['maspackage']['OtherAllow'],'placeholder'=>'Other Allowence','id'=>'OtherAllow','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('HRA', array('label'=>false,'value'=>$Jclr[0]['maspackage']['HRA'],'placeholder'=>'HRA','required'=>true,'id'=>'HRA','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('Bonus', array('label'=>false,'value'=>$Jclr[0]['maspackage']['Bonus'],'placeholder'=>'Bonus','id'=>'Bonus','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('PLI', array('label'=>false,'value'=>$Jclr[0]['maspackage']['PLI'],'placeholder'=>'PLI','id'=>'PLI','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <label class="col-sm-2 control-label">Gross(Rs.)</label>
         <div class="col-sm-1" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2">
            <?php echo $this->Form->input('Gross', array('label'=>false,'value'=>$Jclr[0]['maspackage']['Gross'],'placeholder'=>'Gross','required'=>true,'id'=>'Gross','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('EPF', array('label'=>false,'value'=>$Jclr[0]['maspackage']['EPF'],'placeholder'=>'EPF','id'=>'EPF','oninput'=>'cntepf(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('ESIC', array('label'=>false,'value'=>$Jclr[0]['maspackage']['ESIC'],'placeholder'=>'ESIC','required'=>true,'oninput'=>'cntesic(this.value);','id'=>'ESIC','onKeyPress'=>'return checkNumber(this.value,event)')); ?>    
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('Professional', array('label'=>false,'value'=>$Jclr[0]['maspackage']['Professional'],'placeholder'=>'Professional Tax.','id'=>'Professional','oninput'=>'cntesic(this.value);','oninput'=>'cntProfessional(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-1" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2">
            <?php echo $this->Form->input('NetInHand', array('label'=>false,'value'=>$Jclr[0]['maspackage']['NetInHand'],'placeholder'=>'Net In Hand','required'=>true,'id'=>'NetInHand','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
        <div class="col-sm-1"></div>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('EPFCO', array('label'=>false,'value'=>$Jclr[0]['maspackage']['EPFCO'],'placeholder'=>'EPF Co.','id'=>'EPFCO','required'=>true,'oninput'=>'cntEPFCO(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('ESICCO', array('label'=>false,'value'=>$Jclr[0]['maspackage']['ESICCO'],'placeholder'=>'ESIC CO','id'=>'ESICCO','required'=>true,'oninput'=>'cntESICCO(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>      
        </div>
    ...
    <div class="form-group has-info has-feedback">   
        ...
        <div class="col-sm-2">
            <?php echo $this->Form->input('Admin', array('label'=>false,'value'=>$Jclr[0]['maspackage']['Admin'],'placeholder'=>'Admin Charges.','id'=>'Admin','required'=>true,'oninput'=>'cntAdmin(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-1" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2">
            <?php echo $this->Form->input('CTC', array('label'=>false,'value'=>$Jclr[0]['maspackage']['CTC'],'placeholder'=>'CTC','id'=>'CTC','required'=>true,'onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
    </div>
