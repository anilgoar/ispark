            ...
            <div class="box-content box-con" >
                ...
                <div class="form-group has-info has-feedback">
                   <label class="col-sm-2 control-label">Marital Status <span class="req">*</span></label>
                    ...
                    <div class="col-sm-3">                     
                        <?php echo $this->Form->input('Qualification', array('label'=>false,'class'=>'form-control','value'=>$Jclr['Masjclrentry']['Qualification'],'id'=>'Qualification','options'=>array('UNDER GRADUATE'=>'UNDER GRADUATE','GRADUATE'=>'GRADUATE','POST GRADUATE'=>'POST GRADUATE','MASTER DEGREE'=>'MASTER DEGREE','ENGINEERING'=>'ENGINEERING'),'empty'=>'Select')); ?>
                    </div> 
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="DOJ" id="DOJ" class="form-control datepickers" value="<?php echo date_format(date_create($Jclr['Masjclrentry']['DOJ']),'d-M-Y');?>" autocomplete="off" readonly="" onchange="validatedob()" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top:30px;" >
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="AcBank" id="AcBank" value="<?php echo $Jclr['Masjclrentry']['AcBank'];?>"   class="form-control" >
                    </div>
                    
                    <label class="col-sm-3 control-label">Branch Name <span class="req"></span></label>
                    <div class="col-sm-3">
                        <input type="text" name="AcBranch" id="AcBranch" value="<?php echo $Jclr['Masjclrentry']['AcBranch'];?>"  class="form-control" >
                    </div>
                ...
                <div class="form-group has-info has-feedback">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="AccHolder" id="AccHolder" value="<?php echo $Jclr['Masjclrentry']['AccHolder'];?>"  class="form-control" >
                    </div>
                ...
                <div class="form-group has-info has-feedback">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="IFSCCode" id="IFSCCode" value="<?php echo $Jclr['Masjclrentry']['IFSCCode'];?>" class="form-control" >
                    </div>
