    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <?php echo $this->Form->create('ExpenseEntries',array('action'=>'bm_multi_final_save')); ?>
                    ...
                    <?php $i =1; //print_r($data); exit;
                         foreach($data as $exp):
                            echo "<tr>";
                                ...
                                echo "<td>".$i++."</td>";
                                echo "<td align=\"center\">".$this->Html->link($exp['em']['Branch'],array('controller'=>'ExpenseEntries','action'=>'edit_tmp_bm',
                                    '?'=>array('id'=>$exp['em']['Id'],'qry'=>$qry),'full_base' => true))."</td>";
