...
<div id="main" class="container-fluid expanded-panel" style = "overflow:auto">
		...
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
						...
						<?php if(in_array('10',$page_access)){echo $this->Html->link('<i class="fa fa-dashboard"></i>'.'<span>Invoice Status<span>',array('controller'=>'InitialInvoices','action'=>'dashboard','full_base' => true),array('escape'=>false));} ?>
                                ...
                                <?php if(in_array('43',$page_access) || in_array('176',$page_access) || in_array('177',$page_access) ||  in_array('180',$page_access) ) { ?>
                                <li class="drop-down">
						...
						<span class="hidden-xs">Business Dashboard</span> 
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><?php if(in_array('43',$page_access)) {echo $this->Html->link('<i class="fa fa-dashboard"></i>'.'<span>Business Dashboard<span>',array('controller'=>'Dashs','action'=>'view','full_base' => true),array('escape'=>false));} ?></li>
                                        <li> <?php if(in_array('176',$page_access)){echo $this->Html->link('View Business Dashboard',array('controller'=>'Targets','action'=>'view_freeze_request','full_base' => true));} ?></li>
                                        <li>     <?php if(in_array('177',$page_access)){echo $this->Html->link('Approve Business Dashboard',array('controller'=>'Targets','action'=>'view_freeze_request_for_approval','full_base' => true));} ?></li>
                                        <li><?php if(in_array('180',$page_access)){echo $this->Html->link('Business Mail Scheduler',array('controller'=>'MailSchedulers','action'=>'business_dashboard_schedular','full_base' => true),array('escape'=>false));} ?></li>
                                    </ul>
                                </li>
                                <?php } ?>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu"> 
                                            ...
                                            <li><?php if(in_array('30',$page_access)){echo $this->Html->link('Edit Cost Center',array('controller'=>'costCenterMasters','action'=>'view','full_base' => true));} ?></li>
                                            ...
                                            <li><?php if(in_array('182',$page_access)){echo $this->Html->link('Revenue Out-Source',array('controller'=>'Provisions','action'=>'bill_outsource','full_base' => true));} ?></li>
                                            ...
                                            <li><?php if(in_array('178',$page_access)){echo $this->Html->link('View & Edit Provision',array('controller'=>'Provisions','action'=>'view','full_base' => true));} ?></li>
                                            <li><?php if(in_array('179',$page_access)){echo $this->Html->link('Provision Approve',array('controller'=>'Provisions','action'=>'view_provision_change_request','full_base' => true));} ?></li>
                                            ...
                                            <li><?php if( in_array('58',$page_access) ){echo $this->Html->link('Cost Center Email',array('controller'=>'CostCenterEmails','action'=>'index','full_base' => true));} ?></li>
                                            <li><?php if( in_array('175',$page_access) ){echo $this->Html->link('Cost Center Pending',array('controller'=>'CostCenterMasters','action'=>'tmp_view_pending','full_base' => true));} ?></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><?php if(in_array('17',$page_access)){echo $this->Html->link('View Invoice To Ahmedabad',array('controller'=>'InitialInvoices','action'=>'view_ahmd','full_base' => true));} ?></li>
                                                <li><?php if(in_array('168',$page_access)){echo $this->Html->link('Invoice Status Change Approval',array('controller'=>'InitialInvoices','action'=>'view_status_change_request','full_base' => true));} ?></li>
                                                <li><?php if(in_array('169',$page_access)){echo $this->Html->link('Aprroval Invoice Delete Request',array('controller'=>'InitialInvoices','action'=>'delete_invoice','full_base' => true));} ?></li>
					</ul>
			</li>
                         <?php  } ?>
	 				...
	 				<li>
                            ...
                            <?php if(in_array('22', $page_access) || in_array('23', $page_access) || in_array('24', $page_access) || in_array('25', $page_access) || in_array('26', $page_access) || in_array('27', $page_access) || in_array('122', $page_access)) { ?>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
					...
					<ul class="dropdown-menu">
						...
						<li><?php if(in_array('25',$page_access)){echo $this->Html->link('Bill Stages',array('controller'=>'BillApprovalStages','action'=>'view','full_base' => true));} ?></li>
                                                ...
                                                <li><?php if(in_array('181',$page_access)){echo $this->Html->link('Provision Edit Report',array('controller'=>'ProvisionReports','action'=>'provision_edit_report','full_base' => true));} ?></li>
			...
			<?php } ?>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
                                            <li class="dropdown">
                                                <a href="<?php echo $this->webroot; ?>Finances" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">Business Case</span>
                                            ...
                                            <li class="dropdown">
                                                <a href="<?php echo $this->webroot; ?>Finances/grn" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">GRN</span>
                                            ...
                                            <li class="dropdown">
                                                <a href="<?php echo $this->webroot; ?>Finances/grn_vendor" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						...
						<li class="dropdown">
                                                <a href="<?php echo $this->webroot; ?>Finances/book_grn" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">Book GRN</span>
                                               ...
                                               <li class="dropdown">
                                                <a href="<?php echo $this->webroot; ?>Finances/imprest_allotment" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">Imprest Allotment</span>
                                                </a>
                                                </li>
                                                <li class="dropdown">
                                                <a href="<?php echo $this->webroot; ?>Finances/pnl_field_entry" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">P&l Master</span>
                                                </a>
                                                </li>
					</ul>
				</li>
			...
			<?php } ?>
                        <?php if(
                                 ...
                                 { ?>
                                 <li class="dropdown">
                            <a href="<?php echo $this->webroot.'FinanceReports'; ?>" class="dropdown-toggle">
                                <i class="fa fa-pencil-square-o"></i>
			...
			<?php } ?>
			 ...
			 <?php if(
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">HR Manpower</span>
					</a>
					<ul class="dropdown-menu">
 ...
 <li><?php if(in_array('108',$page_access)){ echo $this->Html->link('Account Validation',array('controller'=>'Jclrs','action'=>'account','full_base' => true));} ?></li>
			...
			<?php if(in_array('90',$page_access) ||  in_array('112',$page_access)) { ?><li><?php echo $this->Html->link('View Prospect',array('controller'=>'prospects','action'=>'view_sales','full_base' => true)); ?></li><?php } ?>
                        ...
                        <?php if(in_array('90',$page_access) ||  in_array('165',$page_access)) { ?><li><?php echo $this->Html->link('Add Lead Source',array('controller'=>'prospects','action'=>'lead_source_master','full_base' => true)); ?></li><?php } ?>  
                        <?php if(in_array('90',$page_access) ||  in_array('173',$page_access)) { ?><li><?php echo $this->Html->link('DisApproved Prospect',array('controller'=>'prospects','action'=>'disapproved_sales','full_base' => true)); ?></li><?php } ?>  
