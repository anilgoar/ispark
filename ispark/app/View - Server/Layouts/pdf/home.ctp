		...
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><?php echo $this->Html->link('Add Branch',array('controller'=>'Addbranches','action'=>'index','full_base' => true)); ?></li>
						<li><?php echo $this->Html->link('Add Client',array('controller'=>'Addclients','action'=>'index','full_base' => true)); ?></li>
						<li><?php echo $this->Html->link('Cost Center',array('controller'=>'costCenterMasters','action'=>'index','full_base' => true)); ?></li>
...
-->					</ul>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><?php echo $this->Html->link('Initial Invoice',array('controller'=>'InitialInvoices','action'=>'index','full_base' => true)); ?></li>
						<li><?php echo $this->Html->link('View Invoice',array('controller'=>'InitialInvoices','action'=>'view','full_base' => true)); ?></li>
						<li><?php echo $this->Html->link('View Initial Invoice',array('controller'=>'InitialInvoices','action'=>'view_branch','full_base' => true)); ?></li>
						<li><?php echo $this->Html->link('Download Invoice',array('controller'=>'InitialInvoices','action'=>'download','full_base' => true)); ?></li>
					</ul>
			</li>
<!--				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
