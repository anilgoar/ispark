...
<script>
    ...
    $.post("<?php echo $this->webroot;?>DocumentValidations/getcostcenter",{BranchName:BranchName}, function(data){
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('DocumentValidations',array('action'=>'index','class'=>'form-horizontal')); ?>
                        ...
                        <table class = "table table-striped table-hover  responstable"  >     
                            ...
                            <tbody>         
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php $this->webroot;?>DocumentValidations/viewdetails?EJEID=<?php echo $EJEID;?>">View</a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>   
