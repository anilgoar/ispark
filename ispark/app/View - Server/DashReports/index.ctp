...
<?php $this->Form->create('Add',array('class'=>'form-horizontal', 'url'=>'add','enctype'=>'multipart/form-data')); ?>
	...
	<div class="form-group has-success has-feedback">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<button class="btn btn-info btn-label-left" onClick="report_validate12();">Export</button>
			</div>
		</div>
