...
<div class="box-content" style="background-color:#ffffff">
    <h4 class="page-header textClass">Mobile Details<?php echo $this->Session->flash(); ?></h4>

    <?php echo $this->Form->create('Connectivitie',array('class'=>'form-horizontal','action'=>'mobile')); ?>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                ...
                <?php echo $this->Form->input('ConnectivityType',array('label' => false,'options'=>array('Postpaid'=>'Postpaid','Prepaid'=>'Prepaid'),'class'=>'form-control','empty'=>'Select','id'=>'ConnectivityType')); ?>
                <span class="input-group-addon"><i class="fa fa-group"></i></span>
            </div>    
        </div>
        <label class="col-sm-2 control-label">Cunsumer code</label>
        <div class="col-sm-3">
            <div class="input-group">
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                        ...
                        <?php	echo $this->Form->input('BillingType', array('label'=>false,'class'=>'form-control','value'=>'','placeholder'=>'Billing Type','required'=>true)); ?>
                <span class="input-group-addon"><i class="fa fa-group"></i></span>
            </div>
        </div>
