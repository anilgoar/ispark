...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo $this->Form->input('branch_name', array('label'=>false,'options'=>$branch_master,'id'=>'branch_name','empty'=>'Select','class'=>'form-control','onchange'=>"costcenter(this.value);",'required'=>true)); ?>
    </div>
