...
<div class="box-content">
	...
	<?php echo $this->Form->create('Targets',array('class'=>'form-horizontal', 'url'=>'save_freeze_data')); ?>			
    ...
    <table border="2" class = "table table-striped table-hover  responstable" >
        ...
        <tr style="text-align:center">
            ...
            <th colspan="3" style="text-align:center"><b>Revenue</b></th>
            <th colspan="3" style="text-align:center"><b>Direct Cost</b></th>
            <th colspan="3" style="text-align:center"><b>Indirect Cost</b></th>
            <th colspan="3" style="text-align:center"><b>OP</b></th>
            <th colspan="3" style="text-align:center"><b>OP%</b></th>
