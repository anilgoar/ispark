					...
					<table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
						...
						<?php
							 ...
							 $hide['app_tax_cal']=$this->request->data['InitialInvoice']['app_tax_cal'];
                                                         ...
                                                         $hide['apply_gst']=$this->request->data['InitialInvoice']['apply_gst'];
			...
			<div class="box-content no-padding">
				<table class="table table-striped">
						...
						<?php $taxex = 1; if($hide['app_tax_cal']=='1'){
                                                    ...
                                                    if(strtotime($this->request->data['InitialInvoice']['invoiceDate'])>strtotime("2017-06-30"))
                                                    { $taxex = 1.18;
                                                      if($data['GSTType']=='Integrated')
                                                      { 
                                                    ?>
                                                <tr>
                                                    <th>IGST @ 18%</th>
						...
						<tr>
                                                    ...
                                                    <td><?php echo $this->Form->input('InitialInvoice.tax', 
                                                        array('label'=>false,'value'=>round($total*0.14),'readonly'=>true)); ?>
                                                    </td>
                                                </tr>
						<?php if(strtotime($this->request->data['InitialInvoice']['invoiceDate']) > strtotime("2015-11-14")){ $taxex = 1.145; ?>
						<tr>
                                                    <th>SBC @ 0.5%</th>
                                                    <td><?php	echo $this->Form->input('InitialInvoice.sbctax', 
                                                        array('label'=>false,'value'=>round($total*0.005),'readonly'=>true)); ?>
                                                    </td>
                                                </tr>
                                                <?php } if($this->request->data['InitialInvoice']['apply_krishi_tax']=='1'){ $taxex = 1.15; ?>
						<tr>
                                                    <th>KKC @ 0.5%</th><td>
                                                        <?php echo $this->Form->input('InitialInvoice.krishi_tax',
                                                        array('label'=>false,'value'=>round($total*0.005),'type'=>'text','readonly'=>true)); ?>
                                                    </td>
                                                </tr>
                                                <?php }} }
                                                $grnd = 0;
