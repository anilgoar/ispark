		...
		<td height="100" valign="top">
			<table cellpadding="0" cellspacing="0" width="130">
					...
					<tr><td id = "t06"><b><?php if($tbl_invoice['InitialInvoice']['approve_grn']=='Yes') echo $tbl_invoice['InitialInvoice']['grn']; ?>&nbsp;</b></td></tr>
                                        <?php if($tbl_invoice['InitialInvoice']['GSTType'] && !empty($tbl_invoice['InitialInvoice']['grn_createdate']) && strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>
...
<table>
	<tr>
		<td width="227">
			<?php if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>   Corporate Add: <?php } ?>B - 24, Okhla Industrial Area<br>
