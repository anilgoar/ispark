...
$data,'empty' => 'Month','required'=>true,'onChange'=>'getDescription(this);get_provision(this.value)')); ?>
		...
		<div class="form-group has-success has-feedback">
                ...
                <div class="form-group has-success has-feedback">
                    ...
                    <label class="col-sm-2 control-label">Apply Service Tax</label>
                    <div class="col-sm-3"><div class="checkbox-inline" ><label>
                    <?php	echo $this->Form->checkbox('servicetax', array('label'=>false,'checked'=>false)); ?><i class="fa fa-square-o"></i></label></div>(Check for Service Tax)
                    </div> 
                </div>
                <div class="form-group has-success has-feedback">
                    <label class="col-sm-2 control-label">Apply Krishi Tax</label>
                    <div class="col-sm-3">
                        <div class="checkbox-inline" ><label>
                    <?php	echo $this->Form->checkbox('apply_krishi_tax', array('label'=>false,'checked'=>false)); ?><i class="fa fa-square-o"></i></label></div>(Check for Krishi Tax)
                    </div>
                    <label class="col-sm-2 control-label">Apply GST</label>
                    <div class="col-sm-3">
                        <div class="checkbox-inline" ><label>
                    <?php echo $this->Form->checkbox('apply_gst', array('label'=>false,'checked'=>false,'disabled'=>true,'onClick'=>"get_gst_pop_up()")); ?><i class="fa fa-square-o"></i></label></div>(Check for GST)
                    </div>
                </div>
