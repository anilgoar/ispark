...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>SalaryExports/getcostcenter",{BranchName:BranchName}, function(data){
...
function attendanceReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        if(Type ==="Export"){
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>SalaryExports/export_report?BranchName="+BranchName+"&EmpMonth="+EmpMonth+"&EmpYear="+EmpYear; 
        }/*
        else if(Type ==="Process"){
            $.post("<?php echo $this->webroot;?>SalaryExports/salary_process",{BranchName:BranchName,EmpMonth:EmpMonth,EmpYear:EmpYear)}, function(data) {
                $("#loder").hide();
                if(data !=""){
                    $("#divAttendance").html('<div class="col-sm-12" style="color:red;font-weight:bold;" >Record  found.</div>');
                }
                else{
            ...
            //$("#loder").hide();
            //window.location="<?php echo $this->webroot;?>SalaryExports/salary_process?BranchName="+BranchName+"&EmpMonth="+EmpMonth+"&EmpYear="+EmpYear;  
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('SalaryExports',array('action'=>'salary_process','class'=>'form-horizontal')); ?>
