...
function logReport(Type){ 
    ...
    if(From ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>BusinessRules/business_community",{From:From,To:To}, function(data) {
                $("#loder").hide();
                if(data !=""){
            ...
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>BusinessRules/export_business_community?From="+From+"&To="+To;  
