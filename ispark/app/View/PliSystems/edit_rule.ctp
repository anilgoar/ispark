                    ...
                    <table class = "table table-striped table-hover  responstable">     
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="http://mascallnetnorth.in/ispark/Tickets/update_join_alert?id=<?php echo $data['OnboardJoinAlert']['id'];?>"><i title="Edit" style="font-size:20px;cursor: pointer;" class="material-icons">edit</i></a></td>
                            </tr>
