...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>JoinemployeeExports/getcostcenter",{BranchName:BranchName}, function(data){
...
function attendanceReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>JoinemployeeExports/show_report",{BranchName:BranchName,EmpMonth:EmpMonth,EmpYear:EmpYear,CostCenter:CostCenter}, function(data) {
                $("#loder").hide();
                if(data !=""){
            ...
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>JoinemployeeExports/export_report?BranchName="+BranchName+"&EmpMonth="+EmpMonth+"&EmpYear="+EmpYear+"&CostCenter="+CostCenter;  
