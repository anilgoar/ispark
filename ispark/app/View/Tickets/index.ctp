    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <span><?php echo $this->Session->flash(); ?></span>
                <?php echo $this->Form->create('Tickets',array('action'=>'index','class'=>'form-horizontal','id'=>'form1','enctype'=>'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                       <?php echo $this->Form->input('trigger_type',array('label' => false,'options'=>['All'=>'All','bio_id'=>'BioCode','partner_id_req' => 'Partner','email_id'=>'Email','bgv'=>'BGV','ad_id' => 'Ad Id'],'empty'=>'Select','class'=>'form-control','id'=>'type','required'=>true)); ?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <!-- <label class="col-sm-1 control-label">Ticket No.</label>
                    <div class="col-sm-2">
                       <?php //echo $this->Form->input('status',array('label' => false,'placeholder'=>'Ticket No.','class'=>'form-control','id'=>'type','required'=>true)); ?>
                    </div> -->
                       ...
                       ?>
                        <tr>
                            ...
                            <?php if($val['EmpOnService']['ticket_status'] == '1'){?>
                                <?php if($val['EmpOnService']['trigger_type']== 'bgv') {?>
