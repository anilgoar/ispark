...
function logReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>Tickets/report",{BranchName:BranchName,From:From,To:To,CostCenter:CostCenter,status: status,EmpCode:$.trim(EmpCode),trigger_type:trigger_type}, function(data) {
                $("#loder").hide();
                if(data !=""){
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <span>Joiner and Leaver Insights</span>
		</div>
		<div class="box-icons">
