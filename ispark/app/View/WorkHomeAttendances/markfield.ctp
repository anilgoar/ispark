...
function show_mark_list(value){
    var url="<?php $this->webroot;?>markfield?CSN=<?php echo base64_encode(isset($empArr['cost_center'])?$empArr['cost_center']:'');?>";
    if(value!=""){
        window.location.href = "<?php echo $this->webroot;?>WorkHomeAttendances/markfield?CSN=<?php echo $_REQUEST['CSN'];?>&mark_date="+value;
    }
    else{
        window.location.href = url;
    }
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>Mark Work Home Attendance</span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con"> 
                <?php echo $this->Form->create('WorkHomeAttendances',array('class'=>'form-horizontal','action'=>'markfield')); ?>
                ...
                <?php echo $this->Form->create('WorkHomeAttendances',array('class'=>'form-horizontal','action'=>'savefieldmark','onsubmit'=>'return validatdFieldMark()')); ?>
