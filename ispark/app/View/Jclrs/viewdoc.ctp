	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<?php echo $this->Session->flash(); ?>
				<h4 class="page-header">Emp Detials </h4>
...
//print_r($$post['qual_employee']['status']);
					 echo "<tr class=\"".$case[$i%4]."\">";
					 	echo "<td>".$i++."</td>";
						echo "<td >".$post['qual_employee']['EmpCode']."</td>";
						...
						echo "<td>".$post['qual_employee']['Desg']."</td>";
                                    ...
                                    if($post['qual_employee']['Status']==1){ echo "<td style = 'color:Green'>Active</td>";}else{echo "<td style = 'color:red'>Left</td>";}
                                               if($post['qual_employee']['Status']==1){echo "<td align=\"center\"><code>".$this->Html->link(Edit,array('controller'=>'Jclrs','action'=>'save_doc','?'=>array('id'=>$post['qual_employee']['EmpCode']),'full_base' => true))."</code></td>";} else{ echo "<td>Edit </td>"; }
                                               echo "<td align=\"center\"><code>".$this->Html->link(Details,array('controller'=>'Jclrs','action'=>'detailsjclr','?'=>array('id'=>$post['qual_employee']['EmpCode']),'full_base' => true))."</code></td>";
					 echo "</tr>";
					 endforeach;
				?>
                </tbody>
