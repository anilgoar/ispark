        ...
        foreach($row as $k=>$v)
        {
            ...
            foreach($monthArr as $m)
            {
                if(empty($v[$m]['0']['PO Pending'])) $v[$m]['0']['PO Pending'] = 0;
                    echo '<td onClick="myFunction(\''.$k.'@@'.$m.'@@po'.'\')">'.($v[$m]['0']['PO Pending']==''?0:$v[$m]['0']['PO Pending']).'</td>';
            ...
            foreach($monthArr as $m)
            {
                    echo '<td onClick="myFunction(\''.$k.'@@'.$m.'@@grn'.'\')">'.($v[$m]['0']['GRN Pending']==''?0:$v[$m]['0']['GRN Pending']).'</td>';
            ...
            foreach($monthArr as $m)
            {
                    echo '<td onClick="myFunction(\''.$k.'@@'.$m.'@@invoice'.'\')">'.($v[$m]['0']['InvoiceSubmit']==''?0:$v[$m]['0']['InvoiceSubmit']).'</td>';
