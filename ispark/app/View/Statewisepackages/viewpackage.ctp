...
window.onload = function() {
    $.post("<?php echo $this->webroot;?>Statewisepackages/get_state_wise_package_type_list",{StateName:"<?php echo $dt['StateName'];?>",StateValue:"<?php echo $dt['PackageType']?>"},function(data){
...
function Design(val){
    ...
    if(BranchName ===""){
        ...
        $.post("Masmasters/get_design",{val,BranchName},function(data){
            $('#tower').html(data);
        });
    }
  }
...
function getCostCenter(BranchName){ 
    if(BranchName !=""){
        $.post("<?php echo $this->webroot;?>Masmasters/getcostcenter",{BranchName:BranchName}, function(data){
            $("#CostCenter").html(data);
        }); 
    }
    else{
        $("#CostCenter").html("<option value=''>Select</option>");
    }
}
</script>
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box box-con">
            <div class="box-header"  >
                <div class="box-name">
                    <span>EDIT STATE WISE PACKAGE MASTER</span>
		</div>
		<div class="box-icons">
...
<div class="box-content" >
    ...
    <?php echo $this->Form->create('maspackagestatewise',array('class'=>'form-horizontal')); ?>
	
	<input type="hidden" name="packageid" value="<?php echo $dt['id'];?>" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php echo $this->Form->input('StateName',array('label' => false,'value'=>$dt['StateName'],'value'=>$dt['StateName'],'options'=>$branchName,'empty'=>'Select','class'=>'form-control','id'=>'BranchName','required'=>true)); ?>
            </div>    
        </div>
    </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php 
				echo $this->Form->input('PackageType',array('label' => false,'value'=>$dt['PackageType'],'options'=>'','empty'=>'Select','class'=>'form-control','id'=>'CostCenter','required'=>true)); 
				?>
            </div>    
        </div>
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php	echo $this->Form->input('PackageAmount', array('label'=>false,'value'=>$dt['PackageAmount'],'placeholder'=>'Package','id'=>'PackageAmount','required'=>true,'onKeyPress'=>'return checkNumber(this.value,event)')); ?>
            </div>    
        </div>
         </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php echo $this->Form->input('Basic',array('label' => false,'value'=>$dt['Basic'],'placeholder'=>'Basic','id'=>'Basic', 'oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
            </div>    
        </div>
        <div class="col-sm-1"></div>
        ...
        <div class="col-sm-2" >
           <?php echo $this->Form->input('Conveyance',array('label' => false,'value'=>$dt['Conveyance'],'id'=>'Conveyance','placeholder'=>'Conveyance' ,'oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Portfolio', array('label'=>false,'value'=>$dt['Portfolio'],'type'=>'text','placeholder'=>'Portfolio','id'=>'Portfolio','oninput'=>'grossAmount(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>      
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Medical', array('label'=>false,'value'=>$dt['Medical'],'placeholder'=>'Medical Allowance','id'=>'Medical','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Special', array('label'=>false,'value'=>$dt['Special'],'placeholder'=>'Special Allowance','id'=>'Special','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('OtherAllow', array('label'=>false,'value'=>$dt['OtherAllow'],'placeholder'=>'Other Allowence','id'=>'OtherAllow','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('HRA', array('label'=>false,'value'=>$dt['HRA'],'placeholder'=>'HRA','required'=>true,'id'=>'HRA','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Bonus', array('label'=>false,'value'=>$dt['Bonus'],'placeholder'=>'Bonus','id'=>'Bonus','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('PLI', array('label'=>false,'value'=>$dt['PLI'],'placeholder'=>'PLI','id'=>'PLI','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <label class="col-sm-1 control-label">Gross(Rs.)</label>
         <div class="col-sm-2" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Gross', array('label'=>false,'value'=>$dt['Gross'],'placeholder'=>'Gross','required'=>true,'id'=>'Gross','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
        </div>
         <div class="col-sm-1"></div>
          </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('EPF', array('label'=>false,'value'=>$dt['EPF'],'placeholder'=>'EPF','id'=>'EPF','oninput'=>'cntepf(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('ESIC', array('label'=>false,'value'=>$dt['ESIC'],'placeholder'=>'ESIC','required'=>true,'oninput'=>'cntesic(this.value);','id'=>'ESIC','onKeyPress'=>'return checkNumber(this.value,event)')); ?>    
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Professional', array('label'=>false,'value'=>$dt['Professional'],'placeholder'=>'Professional Tax.','id'=>'Professional','oninput'=>'cntesic(this.value);','oninput'=>'cntProfessional(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2" >
            <?php echo $this->Form->input('NetInHand', array('label'=>false,'value'=>$dt['NetInHand'],'placeholder'=>'Net In Hand','required'=>true,'id'=>'NetInHand','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
        <div class="col-sm-1"></div>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('EPFCO', array('label'=>false,'value'=>$dt['EPFCO'],'placeholder'=>'EPF Co.','id'=>'EPFCO','required'=>true,'oninput'=>'cntEPFCO(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('ESICCO', array('label'=>false,'value'=>$dt['ESICCO'],'placeholder'=>'ESIC CO','id'=>'ESICCO','required'=>true,'oninput'=>'cntESICCO(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>      
        </div>
    ...
    <div class="form-group has-info has-feedback">   
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Admin', array('label'=>false,'value'=>$dt['Admin'],'placeholder'=>'Admin Charges.','id'=>'Admin','required'=>true,'oninput'=>'cntAdmin(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2" >
            <?php echo $this->Form->input('CTC', array('label'=>false,'value'=>$dt['CTC'],'placeholder'=>'CTC','id'=>'CTC','required'=>true,'onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
    </div>
    
    <div class="form-group has-info has-feedback">
        <div class="col-sm-10" >
            <input onclick='return window.location.href = "<?php echo $this->webroot;?>statewisepackages/editstatewisepackage"' type="button" value="Back" class="btn btn-primary btn-new pull-right" style="margin-left: 5px;" />
            <input type='submit' class="btn btn-info btn-new pull-right" value="Update">
        </div>
    </div>
    
    <div class="form-group" id="tower" >
