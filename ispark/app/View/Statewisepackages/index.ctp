...
function getBranch(StateName){
	...
	$.post("Statewisepackages/get_state_wise_package_type_list",{StateName:StateName,StateValue:''},function(data){
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box box-con">
            <div class="box-header"  >
                <div class="box-name">
                    <span>ADD STATE WISE PACKAGE MASTER</span>
		</div>
		<div class="box-icons">
...
<div class="box-content" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php echo $this->Form->input('StateName',array('label' => false,'options'=>$branchName,'empty'=>'Select','class'=>'form-control','id'=>'BranchName','onchange'=>'getBranch(this.value)','required'=>true)); ?>
            </div>    
        </div>
    </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php	echo $this->Form->input('Band', array('label'=>false,'options'=>$BandList,'required'=>true,'empty'=>'Select Band','class'=>'form-control','onchange'=>'Design(this.value)')); ?>
            </div>    
        </div>
		-->
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php	echo $this->Form->input('PackageAmount', array('label'=>false,'placeholder'=>'Package','id'=>'PackageAmount','required'=>true,'onKeyPress'=>'return checkNumber(this.value,event)')); ?>
            </div>    
        </div>
         </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php echo $this->Form->input('Basic',array('label' => false,'value'=>'','placeholder'=>'Basic','id'=>'Basic', 'oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
            </div>    
        </div>
        <div class="col-sm-1"></div>
        ...
        <div class="col-sm-2" >
           <?php echo $this->Form->input('Conveyance',array('label' => false,'id'=>'Conveyance','placeholder'=>'Conveyance' ,'oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Portfolio', array('label'=>false,'type'=>'text','placeholder'=>'Portfolio','id'=>'Portfolio','oninput'=>'grossAmount(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>      
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Medical', array('label'=>false,'value'=>'','placeholder'=>'Medical Allowance','id'=>'Medical','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Special', array('label'=>false,'value'=>'','placeholder'=>'Special Allowance','id'=>'Special','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('OtherAllow', array('label'=>false,'value'=>'','placeholder'=>'Other Allowence','id'=>'OtherAllow','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('HRA', array('label'=>false,'value'=>'','placeholder'=>'HRA','required'=>true,'id'=>'HRA','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Bonus', array('label'=>false,'value'=>'','placeholder'=>'Bonus','id'=>'Bonus','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('PLI', array('label'=>false,'value'=>'','placeholder'=>'PLI','id'=>'PLI','oninput'=>'grossAmount();','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <label class="col-sm-1 control-label">Gross(Rs.)</label>
         <div class="col-sm-2" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Gross', array('label'=>false,'value'=>'','placeholder'=>'Gross','required'=>true,'id'=>'Gross','onKeyPress'=>'return checkNumber(this.value,event)')); ?> 
        </div>
         <div class="col-sm-1"></div>
          </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('EPF', array('label'=>false,'value'=>'','placeholder'=>'EPF','id'=>'EPF','oninput'=>'cntepf(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('ESIC', array('label'=>false,'value'=>'','placeholder'=>'ESIC','required'=>true,'oninput'=>'cntesic(this.value);','id'=>'ESIC','onKeyPress'=>'return checkNumber(this.value,event)')); ?>    
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Professional', array('label'=>false,'value'=>'','placeholder'=>'Professional Tax.','id'=>'Professional','oninput'=>'cntesic(this.value);','oninput'=>'cntProfessional(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2" >
            <?php echo $this->Form->input('NetInHand', array('label'=>false,'value'=>'','placeholder'=>'Net In Hand','required'=>true,'id'=>'NetInHand','onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
        <div class="col-sm-1"></div>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('EPFCO', array('label'=>false,'value'=>'','placeholder'=>'EPF Co.','id'=>'EPFCO','required'=>true,'oninput'=>'cntEPFCO(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('ESICCO', array('label'=>false,'value'=>'','placeholder'=>'ESIC CO','id'=>'ESICCO','required'=>true,'oninput'=>'cntESICCO(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>      
        </div>
    ...
    <div class="form-group has-info has-feedback">   
        ...
        <div class="col-sm-2" >
            <?php echo $this->Form->input('Admin', array('label'=>false,'value'=>'','placeholder'=>'Admin Charges.','id'=>'Admin','required'=>true,'oninput'=>'cntAdmin(this.value);','onKeyPress'=>'return checkNumber(this.value,event)')); ?>        
        </div>
        ...
        <div class="col-sm-2" style="position:relative;left:21px;" ></div>
        <div class="col-sm-2" >
            <?php echo $this->Form->input('CTC', array('label'=>false,'value'=>'','placeholder'=>'CTC','id'=>'CTC','required'=>true,'onKeyPress'=>'return checkNumber(this.value,event)')); ?>
        </div>
    </div>
    
    <div class="form-group has-info has-feedback">
        <div class="col-sm-10" >
            <input onclick='return window.location="Menus?AX=OA=="' type="button" value="Back" class="btn btn-primary btn-new pull-right" style="margin-left: 5px;" />
