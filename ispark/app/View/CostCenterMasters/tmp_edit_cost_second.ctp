<?php echo $this->Form->create('CostCenterMaster',array('class'=>'form-horizontal','action'=>'tmp_update_cost_second')); 
$cost = $cost_master['TmpCostCenterMaster'];
//echo "<pre>";
//print_r($cost);
			...
			<?php echo $this->Session->flash(); ?>
				<h4 class="page-header">Process Details </h4>
					...
					<div class="form-group has-success has-feedback">
						...
						<div class="col-sm-2">
                                                    <div id='process'>
                                                        <?php	echo $this->Form->input('process', array('label'=>false,'class'=>'form-control','options'=>array($cost['process']=>$cost['process']),'empty' => 'Select Process','value'=>$cost['process'])); ?></div>
						</div>
						...
						<?php endforeach; ?><?php unset($Category); ?>
							<?php	echo $this->Form->input('category', array('label'=>false,'class'=>'form-control','options' => $data,'empty' => 'Select category','value'=>$cost['category'],'required'=>false)); ?>
						...
						<?php	echo $this->Form->input('tower', array('label'=>false,'class'=>'form-control','value' => $cost['tower'])); ?>
                                ...
                                <div class="form-group has-success has-feedback">
                                        ...
                                        <div class="form-group has-success has-feedback">
                                            ...
                                            <?php echo $this->Form->input('ServiceTaxNo', array('label'=>false,'class'=>'form-control','placeholder' => 'GST No','value'=>$cost['ServiceTaxNo'],'required'=>true)); ?>
                                            </div>
					</div>
                                <div class="form-group has-success has-feedback">
                                            <label class="col-sm-2 control-label">HSN Code</label>
                                            <div class="col-sm-4">
                                            <?php echo $this->Form->input('HSNCode', array('label'=>false,'class'=>'form-control','placeholder' => 'HSNCode','value'=>$cost['HSNCode'],'required'=>true)); ?>
                                            </div>
					</div> 
                                <div class="form-group has-success has-feedback">
                                            <label class="col-sm-2 control-label">SAC Code</label>
                                            <div class="col-sm-4">
                                            <?php echo $this->Form->input('SACCode', array('label'=>false,'class'=>'form-control','placeholder' => 'SACCode','value'=>$cost['SACCode'],'required'=>true)); ?>
                                            </div>
					</div> 
			...
			<div class="box-content">
				<h4 class="page-header">Commercial Details </h4>
					...
					<div class="form-group has-success has-feedback">
						...
						<div class="col-sm-2">
						<?php	echo $this->Form->input('revenueType', array('label'=>false,'class'=>'form-control','options' => array('Fixed'=>'Fixed','Variable'=>'Variable','Both'=>'Both'),'empty' => 'Select Revenue','value'=>$cost['revenueType'])); ?>
						</div>
                                                <label class="col-sm-2 control-label">Fixed</label>
						<div class="col-sm-2">
							<?php	echo $this->Form->input('fixed', array('label'=>false,'class'=>'form-control','options' => array('Seat'=>'Seat','Fos'=>'Fos','Manpower'=>'Manpower','Seat&Fos'=>'Seat&Fos'),'empty' => 'Select Fixed','value'=>$cost['fixed'])); ?>
						</div>
					...
					<div class="form-group has-success has-feedback">
						...
						<?php //endforeach; ?><?php //unset($Addclient); ?>
							<?php	echo $this->Form->input('a_address5', array('label'=>false,'class'=>'form-control','value' => $cost['a_address5'])); ?>
                                        ...
                                        <div class="form-group has-success has-feedback">
                                            <label class="col-sm-2 control-label">Client HSN Code</label>
                                            <div class="col-sm-4">
                                            <?php echo $this->Form->input('VendorHSNCode', array('label'=>false,'value'=>$cost['VendorHSNCode'],'class'=>'form-control','placeholder' => 'HSN Code','required'=>true)); ?>
                                            </div>
					</div>
                                
                                        <div class="form-group has-success has-feedback">
                                            <label class="col-sm-2 control-label">Client SAC Code</label>
                                            <div class="col-sm-4">
                                            <?php echo $this->Form->input('VendorSACCode', array('label'=>false,'class'=>'form-control','placeholder' => 'SAC Code','value'=>$cost['VendorSACCode'],'required'=>true)); ?>
                                            </div>
					</div>
