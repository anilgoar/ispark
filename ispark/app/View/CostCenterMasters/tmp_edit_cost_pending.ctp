<?php echo $this->Form->create('CostCenterMaster',array('class'=>'form-horizontal','action'=>'tmp_update_cost_pending','onsubmit'=>"return val_cs()")); 
			...
			<div class="box-content">
				...
				<div class="clearfix"></div>
					<div class="form-group">
                                ...
                                ?>
                              <div class="col-sm-2">
                            <button name="submit" value="Edit" type="submit" class="btn btn-primary btn-label-left" >Edit</button>
			</div>
