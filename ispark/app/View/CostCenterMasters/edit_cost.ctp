					...
					<div class="form-group has-success has-feedback">
						...
						<?php	echo $this->Form->input('tower', array('label'=>false,'class'=>'form-control','value' => $cost['tower'])); ?>
                                ...
                                <div class="form-group has-success has-feedback">
                                        ...
                                        <div class="form-group has-success has-feedback">
                                            <label class="col-sm-2 control-label">Group Cost Center</label>
                                            <div class="col-sm-4">
                                            <?php echo $this->Form->input('group_cost_center', array('label'=>false,'class'=>'form-control','placeholder' => 'Group Cost Center','value'=>$cost['group_cost_center'])); ?>
                                            </div>
					</div>
                                
                                        <div class="form-group has-success has-feedback">
                                            <label class="col-sm-2 control-label">Cost Center Type</label>
                                            <div class="col-sm-4">
                                            <?php echo $this->Form->input('cost_center_type', array('label'=>false,'class'=>'form-control','empty' => 'Type','options'=>array('T'=>"Telecom","N"=>"Non - Telecom"),'value'=>$cost['cost_center_type'],'required'=>true)); ?>
                                            </div>
					</div>
