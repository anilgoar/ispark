    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('EmployeeDetails',array('action'=>'index','class'=>'form-horizontal')); ?>
                        ...
                        <table class = "table table-striped table-hover  responstable"  >     
                            ...
                            <tbody>         
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td>
                                        <a href="<?php $this->webroot;?>EmployeeDetails/viewdetails?EJEID=<?php echo $EJEID;?>">View</a> | 
                                        <?php if($val['Masjclrentry']['Status'] =="1"){ ?>
                                            <a href="<?php $this->webroot;?>EditMasjclrs/newjclr?id=<?php echo $val['Masjclrentry']['id'];?>">Edit</a>
                                        <?php }else{?>
                                            <span>Edit</span>
                                        <?php }?>
                                    </td>
