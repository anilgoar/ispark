            ...
            <div class="box-content box-con">
                ...
                <div class="form-group" style="position: relative;top:-30px;" >
                    <div class="col-sm-12" style="margin-top:5px;" >
                        <?php if($data['Masjclrentry']['EmpType'] =="ONROLL"){ ?>
                        ...
                        <?php }else{?>
                        <a  href="#" ><input type='button' class="btn btn-primary pull-right btn-new"  value="Appointment Letter"></a>
                        <?php }?>
                    </div>
                    <div class="col-sm-12">
                ...
                <div class="box" style="position: relative;top:-110px;">
                    ...
                    <div class="box-content box-con">
                        <div class="form-group">  
                            ...
                            <div class="col-sm-2">
                                <input type="password" id="AuthenticationCode" name="AuthenticationCode" autocomplete="off" class="form-control"  required="" >
                            </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12"><input type='button' style="position: relative;top:-100px;" onclick="goBack();" class="btn btn-primary pull-right btn-new"  value="Back"></div>
                </div>
