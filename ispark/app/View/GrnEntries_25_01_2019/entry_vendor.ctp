...
<?php echo $this->Form->create('GrnEntries',array('class'=>'form-horizontal','action'=>'vendor_save')); ?>
<div class="box-content" style="background-color:#ffffff">
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                <?php echo $this->Form->input('FinanceYear',array('label' => false,'options'=>$FinanceYearArr,'class'=>'form-control','empty'=>'Select','style'=>'width:200px;','id'=>'finance_year','required'=>true)); ?>
        ...
        <div class="col-sm-3">
            <div class="input-group">
               <?php echo $this->Form->input('FinanceMonth',array('label' => false,'options'=>array('Jan'=>'Jan','Feb'=>'Feb','Mar'=>'Mar','Apr'=>'Apr','May'=>'May','Jun'=>'Jun',
                   ...
                   'class'=>'form-control','empty'=>'Select','style'=>'width:200px;','id'=>'finance_month','required'=>true)); ?>
        ...
        <div class="col-sm-3">
            <div class="input-group">
               <?php echo $this->Form->input('HeadId',array('label' => false,'options'=>$head,
                   'class'=>'form-control','empty'=>'Select','id'=>'head','style'=>'width:200px;','onChange'=>"getSubHeading()",'required'=>true)); ?>
        ...
        <div class="col-sm-3">
            <div class="input-group">
               <?php echo $this->Form->input('SubHeadId',array('label' => false,'options'=>'',
                   'class'=>'form-control','empty'=>'Select','style'=>'width:200px;','id'=>'subHead','onChange'=>"getVendor()",'required'=>true)); ?>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
                <?php echo $this->Form->input('Vendor',array('label' => false,'options'=>'','style'=>'width:200px;','class'=>'form-control','empty'=>'Select','id'=>'vendorId','onChange'=>'get_branch(this.value)','required'=>true)); ?>
   ...
   <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
               ...
               <?php echo $this->Form->input('bill_date',array('label' => false,'placeholder'=>'Bill Date',
                   'class'=>'form-control','id'=>'bill_date','style'=>'width:200px;','onclick'=>"javascript:NewCssCal ('bill_date','ddMMyyyy','arrow',false,'24',false)",'required'=>true)); ?>
        </div>
    </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
               <?php echo $this->Form->input('Amount',array('label' => false,'value'=>'','placeholder'=>'Amount',
                   'class'=>'form-control','id'=>'Amount','onKeypress'=>'return isNumberKey(event)','value'=>'0','required'=>true,'readonly'=>true)); ?>
        ...
        <div class="col-sm-3">
               ...
               <?php echo $this->Form->texArea('description',array('label' => false,'placeholder'=>'Description',
                   'class'=>'form-control','style'=>'width:200px;','id'=>'description','required'=>true)); ?>
        </div>
    </div>
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-3">
            <div class="input-group">
               <?php echo $this->Form->input('EntryDate',array('label' => false,
                   'class'=>'form-control','placeholder'=>'Date','id'=>'entry_date','style'=>'width:200px;','onclick'=>"javascript:NewCssCal ('entry_date','ddMMyyyy','arrow',false,'24',false)",'readonly'=>true,'required'=>true)); ?>
        ...
        <div class="col-sm-3">
            <div class="input-group">
               <?php echo $this->Form->input('EntryStatus',array('label' => false,'options'=>array('Open'=>'Open','Close'=>'Close'),
                   'class'=>'form-control','style'=>'width:200px;','id'=>'entry_status','required'=>true)); ?>
