    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>PNL File Upload Report</span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con form-horizontal">
                ...
                <?php echo $this->Form->create('PnlfileuploadReports',array('action'=>'index','class'=>'form-horizontal','onSubmit'=>'return validateForm()')); ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input onclick='return window.location="<?php echo $this->webroot;?>MenuIsparks/profitloss"' type="button" value="Back" class="btn btn-primary btn-new pull-right" style="margin-left: 5px;" />
