			...
			<?php echo $this->Session->flash(); ?>
                ...
                <?php $i =1; $case=array('','class');
					 ...
					 echo "<tr class=\"".$case[$i%4]."\">";
					 	echo "<td>".$i++."</td>";
						echo "<td align=\"center\"><code>".$this->Html->link('Select',array('controller'=>'CostCenterMasters','action'=>'tmp_edit_cost_pending','?'=>array('id'=>$post['TmpCostCenterMaster']['id']),'full_base' => true))."</code></td>";
