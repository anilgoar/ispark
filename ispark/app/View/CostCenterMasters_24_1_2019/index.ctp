				...
				<h4 class="page-header">Process Details </h4>
						...
						<?php endforeach; ?><?php unset($Addcompany); ?>
							<?php	echo $this->Form->input('company_name', array('label'=>false,'class'=>'form-control','options' => $data,'empty' => 'Select Company')); ?>
                                                ...
                                                <label class="col-sm-2 control-label"><input type="checkbox" name="Revenue" id="Revenue" value="1" />Revenue</label>
                                                <label class="col-sm-1 control-label"><input type="checkbox" name="Billing" id="Billing" value="1" />Billing</label>
						</div>						
						<div class="form-group">
