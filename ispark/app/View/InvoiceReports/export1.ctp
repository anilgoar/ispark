		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>GST Input/Output Report</span>
				</div>
				<div class="box-icons">
...
echo $this->Form->create('InvoiceReports',array('class'=>'form-horizontal','action'=>'get_report11')); 
			...
			<label class="col-sm-2 control-label"><b style="font-size:14px">Start Date </b></label>
				<div class="col-sm-3">
					<?php	echo $this->Form->input('ToDate', array('label'=>false,'class'=>'form-control','placeholder'=>'Date',
							'onClick'=>"displayDatePicker('data[InvoiceReports][ToDate]');",'required'=>true)); ?>
				</div>
			<label class="col-sm-2 control-label"><b style="font-size:14px">End Date  </b></label>
				<div class="col-sm-3">
					<?php	echo $this->Form->input('FromDate', array('label'=>false,'class'=>'form-control','placeholder'=>'Date',
							'onClick'=>"displayDatePicker('data[InvoiceReports][FromDate]');",'required'=>true)); ?>
				</div>
			
				
		</div>
    <div class="form-group">
       <label class="col-sm-2 control-label"><b style="font-size:14px">GST Output Report</b></label>
       <div class="col-sm-3">
           <input type="radio" value="Output"  name="rtype">
       </div>
       
        <label class="col-sm-2 control-label"><b style="font-size:14px">GST Input Report</b></label>
        <div class="col-sm-3">
            <input type="radio" value="Input"  name="rtype" required="">
       </div>
    </div>
