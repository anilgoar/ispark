...
function exportSalary(){ 
    ...
    if(aIds ==""){
        ...
        if(confirm("Total Amount "+Total_Amount+" and Count "+Total_count+" is ready to rejection. \n Are you sure you want to reject selected record.") == true){
                $(".loader").show();
                return true;
        }else{ 
            return false;
...
function viewSalary(){ 
    ...
    if(EmpMonth ===""){
        ...
        $(".loader").show();
        $.post("<?php echo $this->webroot;?>SalaryTransfers/view_salary_rejection",{BranchName:BranchName,CostCenter:CostCenter,EmpMonth:EmpMonth,EmpYear:EmpYear}, function(data){
...
function sumSalary(Amount,Id){
    ...
    if (checkBox.checked == true){
        var c   = a + b;
        document.getElementById("RejectionRemarks"+Id).required = true;
    }else {
        var c   = a - b;
        document.getElementById("RejectionRemarks"+Id).required = false;
    }
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <form method="post" action="<?php echo $this->webroot;?>SalaryTransfers/update_salary_rejection" onsubmit="return exportSalary()" class="form-horizontal" >
                ...
                <div class="form-group">
                    <div class="col-sm-10" ><div class="loader pull-right" style="display:none;" ></div></div>
                    <div class="col-sm-2">
