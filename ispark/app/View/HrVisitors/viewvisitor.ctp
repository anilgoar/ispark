    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con form-horizontal">
                ...
                <?php echo $this->Form->create('HrVisitors',array('action'=>'viewvisitor','class'=>'form-horizontal','onSubmit'=>'return validateForm()')); ?>
                        ...
                        <table class = "table table-striped table-hover  responstable"  >     
                            <thead>
                                <tr>
                                    ...
                                    <th>Address</th>
                                    -->
                                    <th style="text-align: center;">Whom To Meet</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <!--
                                    <td><input type="checkbox" name="Visitor_Id[]" value="<?php echo $row['Visitor_Id'];?>"></td>
                                    -->
                                    <td style="text-align: center;"><?php echo $i++;?></td>
                                    <td style="text-align: center;"><?php echo $row['branch_name']?></td>
                                    <td style="text-align: center;"><?php echo $row['Source_Of_Information']?></td>
                                    <td><?php echo $row['visitor_name']?></td>
                                    <td style="text-align: center;width: 10%"><?php echo $row['mobile_no']?></td>
                                    <!--
                                    <td><?php echo $row['visitor_address']?></td>
                                    -->
                                    <td style="text-align: center;"><?php echo $row['wt_meet']?></td>
                                    <td style="text-align: center;width: 10%"><?php echo $row['createdate']!=""?date("d-M-Y",strtotime($row['createdate'])):''?></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
