    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con form-horizontal">
                ...
                <?php echo $this->Form->create('HrVisitors',array('action'=>'interviewreport','class'=>'form-horizontal','onSubmit'=>'return validateForm()')); ?>
                        ...
                        <table class = "table table-striped table-hover  responstable"  >     
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $row['InterviewMaster']['BranchName'];?></td>
                                    <td style="text-align: center;"><?php echo $row['InterviewMaster']['Source_Of_Information'];?></td>
                                    <td><?php echo $row['InterviewMaster']['Name'];?></td>
                                    <td style="text-align: center;"><?php echo $row['InterviewMaster']['Mobile_No'];?></td>
                                    <!--
                                    <td><?php echo $row['InterviewMaster']['Address'];?></td>
                                    -->
                                    <td style="text-align: center;"><?php echo $row['InterviewMaster']['Job_Position'];?></td>
                                    
                                    <td style="text-align: center;"><?php echo $row['InterviewMaster']['Create_Date']!=""?date("d-M-Y",strtotime($row['InterviewMaster']['Create_Date'])):''?></td>
