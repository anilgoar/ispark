...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>DeductionDiscards/getcostcenter",{BranchName:BranchName}, function(data){
...
function descardReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>DeductionDiscards/show_report",{BranchName:BranchName,StartDate:StartDate,CostCenter:CostCenter}, function(data) {
                $("#loder").hide();
                if(data !=""){
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('DeductionDiscards',array('action'=>'index','class'=>'form-horizontal','id'=>'showDetails')); ?>
