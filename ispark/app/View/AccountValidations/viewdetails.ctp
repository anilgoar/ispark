		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <div class="form-group" style="position: relative;top:-10px;" >
                    <div class="col-sm-12">
                        <?php if( $CancelCheque !=""){?>
                            <img src="<?php echo $this->webroot.'Doc_File/'.$data['Masjclrentry']['OfferNo'].'/'.$CancelCheque;?>" style="width:100%; height: 300px;" >
                        <?php  }else{ ?>
                            <hr/>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="EmpName" id="EmpName" readonly="" class="form-control" value="<?php echo $data['Masjclrentry']['EmpName'];?>" onkeyup="javascript:capitalize(this.id, this.value);" required="" >
                    </div>
                    <label class="col-sm-2 control-label">Account Holder</label>
                    <div class="col-sm-3">
                        <input type="text" name="AccHolder" id="AccHolder" class="form-control" value="<?php echo $data['Masjclrentry']['AccHolder'];?>" onkeyup="javascript:capitalize(this.id, this.value);" required="" >
                    </div>
                </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="AcBank" id="AcBank" class="form-control" value="<?php echo $data['Masjclrentry']['AcBank'];?>" onkeyup="javascript:capitalize(this.id, this.value);" required="" >
                    </div>
                    <label class="col-sm-2 control-label">Branch Name</label>
                    <div class="col-sm-3">
                        <input type="text" name="AcBranch" id="AcBranch" class="form-control" value="<?php echo $data['Masjclrentry']['AcBranch'];?>" onkeyup="javascript:capitalize(this.id, this.value);" required="" >
                    </div>
                </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="IFSCCode" id="IFSCCode" class="form-control" value="<?php echo $data['Masjclrentry']['IFSCCode'];?>" onkeyup="javascript:capitalize(this.id, this.value);" required="" >
                    </div>
                </div>
