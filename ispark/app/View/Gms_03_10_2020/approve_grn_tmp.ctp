...
<div class="col-xs-12 col-sm-12">
    <div class="box">
        ...
        <div class="box-content" style="background-color:#ffffff; border:1px solid #436e90;">
            <h4 class="page-header textClass" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">GRN First Approval Bucket<?php echo $this->Session->flash(); ?></h4>
            <!--
        ...
        'Jul'=>'Jul','Aug'=>'Aug','Sep'=>'Sep','Oct'=>'Oct','Nov'=>'Nov','Dec'=>'Dec'),'empty' => 'Select Month','value'=>$ExpenseEntryMaster[1],'label' => false,'id'=>'FinanceMonth', 'div' => false,'class'=>'form-control','selected' => $ExpenseMaster['1'],'readonly'=>$readonly)); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->input('Vendor_State_Code',array('label' => false,'options'=>$ExpenseEntryMaster[17]==1?$StateCode:array(),'class'=>'form-control','empty'=>'Select','value'=>$ExpenseEntryMaster[19],'id'=>'Vendor_State_Code','readonly'=>$readonly)); ?>
                </div>
                
                <label class="col-sm-2 control-label">Billing State Code</label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('Billing_State_Code',array('label' => false,'options'=>$ExpenseEntryMaster[17]==1?$StateCode:array(),'class'=>'form-control','empty'=>'Select','value'=>$ExpenseEntryMaster[20],'id'=>'Billing_State_Code','readonly'=>$readonly)); ?>
                </div>
            </div>
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<h4 class="page-header" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Details Entry</h4>
                    ...
                    <tr <?php  foreach ($result as $post): $GTotal1 += $post['teep']['Total']; endforeach; if($GTotal1==$ExpenseEntryMaster[7] && !empty($ExpenseEntryMaster)) { ?> style="display:none" <?php } ?> >
                        ...
                        <th><?php  if($ExpenseEntryMaster[17]=='1') $gst_en="1"; else { $gst_en="0";}  echo $this->Form->input('amount' ,array('label' =>false,'placeholder' => 'Amount','onBlur'=>"getTotalCostAmount('$gst_en','$ExpenseEntryMaster[19]','$ExpenseEntryMaster[20]')",'class' => 'form-control','onKeypress'=>'return isNumberKey(event)')); ?></th>
                        <th>
                        <?php if($ExpenseEntryMaster[17]=='1') { ?>
                        <?php echo $this->Form->input('Rate' ,array('label' =>false,'empty' => 'Select','options'=>array('5'=>'5%','12'=>'12%','18'=>'18%','28'=>'28%'),'class' => 'form-control','onChange'=>"getTotalCostAmount('$gst_en','$ExpenseEntryMaster[19]','$ExpenseEntryMaster[20]');",'onKeypress'=>'return isNumberKey(event)')); ?>
                        <?php } else {
                    ...
                    foreach ($result as $post): 
                        ...
                        $idx.=$post['teep']['Id'].','; ?>
                            ...
                            <td>
                                <?php 
                                if($ExpenseEntryMaster[17]=='1'  && $ExpenseEntryMaster[19]!=$ExpenseEntryMaster[20]){ 
