					...
					<thead>
						<tr class="active">
							...
							<td align="center"><b>Product Name</b></td>
                                                        ...
                                                        <td align="center"><b>Track Changes</b></td>
                                                        <td align="center"><b>Last Diff</b></td>
						</tr>
					</thead>
                                        <tbody>
						...
						<tr>
							...
							<td align="center"><?php echo $post['sp']['ProductName']; ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo $this->webroot.'prospects/view_prospect_tracker_id?id='.$post['sc']['Id']; ?>">View</a>
                                                            
							</td>
                                                        <td>
                                                             <?php if(!empty($post['sc']['HisLastId'])) { ?>
                                                            <a href="<?php echo $this->webroot.'prospects/view_prospect_tracker_track?id='.$post['sc']['Id']; ?>">Last Diff</a>
                                                             <?php } ?>
							</td>
