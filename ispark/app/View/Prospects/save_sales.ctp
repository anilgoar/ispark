...
<div class="form-group">
    <label class="col-sm-2 control-label">Email ID<font color="red">*</font></label>
        <div class="col-sm-4">
        <?php echo $this->Form->input('Email',array('label' => false,'class'=>'form-control','class'=>'form-control','placeholder'=>'Email','type'=>'email','required'=>true)); ?><font color="red">Email is Must</font>
        </div>
...
<div class="form-group">
        ...
        <div class="col-sm-4">
        <?php echo $this->Form->input('LeadSource',array('label' => false,'class'=>'form-control','class'=>'form-control','empty'=>'Select','options'=>$lead_source_master,'required'=>true)); ?>
        </div>
</div>    
