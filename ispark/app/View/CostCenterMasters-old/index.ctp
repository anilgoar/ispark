<?php echo $this->Form->create('CostCenterMaster',array('class'=>'form-horizontal','action'=>'add')); ?>
<div class="row">
			...
			<?php echo $this->Session->flash(); ?>
				<h4 class="page-header">Process Details </h4>
					...
					<div class="form-group has-success has-feedback">
						...
						<div id='client'><?php	echo $this->Form->input('client', array('label'=>false,'class'=>'form-control','options' => '','empty' => 'Select Client')); ?></div>
						...
						<div class="form-group has-success has-feedback">
							...
							<?php	echo $this->Form->input('total_man_date', array('label'=>false,'class'=>'form-control','placeholder' => 'Total Man Date')); ?>
							</div>
						<label class="col-sm-2 control-label">Shrinkage</label>
							<div class="col-sm-2">

							<?php	echo $this->Form->input('shrinkage', array('label'=>false,'class'=>'form-control','placeholder' => 'Shrinkage')); ?>
							</div>
						<label class="col-sm-1 control-label">Attrition</label>
						<div class="col-sm-2">
							<?php	echo $this->Form->input('attrition', array('label'=>false,'class'=>'form-control','placeholder' => 'Attrition')); ?>
						</div>
						...
						<div class="col-sm-2">
							<?php	echo $this->Form->input('over_saldays', array('label'=>false,'class'=>'form-control','options' => array('Yes'=>'Yes','No'=>'No'))); ?>
						...
						<?php  //$data[]= $post['Addclient']['client_name']; ?>
						<?php //endforeach; ?><?php //unset($Addclient); ?>
							<?php	echo $this->Form->input('training_days', array('label'=>false,'class'=>'form-control','placeholder' => 'Training Days')); ?>
						</div>
						<label class="col-sm-1 control-label">Incentive Allowed</label>
						<div class="col-sm-2">

							<?php	echo $this->Form->input('incentive_allowed', array('label'=>false,'class'=>'form-control','options' => array('Yes'=>'Yes','No'=>'No'))); ?>
						</div>
					</div>
						<div class="form-group has-success has-feedback">
						...
						<div class="col-sm-2">
							<?php	echo $this->Form->input('deduction_allowed', array('label'=>false,'class'=>'form-control','placeholder' => 'Deduction Allowed')); ?>
						</div>
