...
<div class="row">
    <div class="col-xs-12 col-sm-12">
		...
		<div class="form-group has-success has-feedback">
                    ...
                    <?php if($cost['CostCenterMaster']['Revenue']=='1') { ?>
                    ...
                    <?php if($cost['CostCenterMaster']['Billing']=='1') { ?>
                <div class="form-group has-success has-feedback">
...
<?php
echo $this->Form->input('billing_active',array('label'=>false,'value'=>$cost['CostCenterMaster']['Billing'],'type'=>'hidden'));
echo $this->Form->input('revenue_active',array('label'=>false,'value'=>$cost['CostCenterMaster']['Revenue'],'type'=>'hidden'));
