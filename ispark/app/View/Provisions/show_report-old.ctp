...
<?php $sumProvision = 0;$sumPO = 0;$sumGRN = 0;$sumInitiated = 0; 
        foreach($row as $k=>$v)
        {
            echo "<tr>";
...
//            echo "<tr>";
//                echo "<td align='center'>Bill To Be Initiated</td>";
//            foreach($monthArr as $m)
//            {
//                    echo '<td onClick="myFunction(\''.$k.'@@'.$m.'@@initaited'.'\')">'.$v[$m]['0']['Billing Pending'].'</td>';
//                    $sumInitiated += $v[$m]['0']['Billing Pending'];
//            }
//            echo "<th>".$sumInitiated."</th>";
//            echo "</tr>";  
        }
?>
<tr>
