    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('ActivateEmployees',array('action'=>'index','class'=>'form-horizontal')); ?>
                            ...
                            <tbody>         
                                ...
                                <tr>
                                 ...
                                 <td><?php echo $val['Masjclrentry']['BranchName'];?></td>
                                    ...
                                    ?>
                                    <td><?php echo date('d M Y',strtotime($val['Masjclrentry']['ResignationDate']));?></td>
                                    <td>
                                        <a href="<?php $this->webroot;?>ActivateEmployees/viewdetails?EJEID=<?php echo $EJEID;?>">Active</a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>   
