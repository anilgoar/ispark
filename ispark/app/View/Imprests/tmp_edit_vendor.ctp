    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="form-horizontal">
                 <?php echo $this->Form->create('Imprests',array('class'=>'form-horizontal','enctype'=>'multipart/form-data')); ?>   
                    ...
                    <div class="form-group">
                            <label class="col-sm-2 control-label">Vendor Name(Tally)</label>
                        <div class="col-sm-10">            
                        <?php echo $this->Form->input('TallyHead',array('label' => false,'class'=>'form-control','id'=>'Vendor','placeholder'=>'Vendor Name',"value"=>$vendor_arr['VendorMaster']['vendor'])); ?>
                        </div>
                    </div>
                    <div class="form-group">
...
<!--                            <td>
                        ...
                        <?php } ?>
                                ...
                                <div class="col-sm-6">
                                    <textarea name="RejectRemarks" id="RejectRemarks" rows="5" ></textarea>
                        </div>
                    </div>
                    ...
                    <div id="form-group">
                        ...
                        <div class="col-sm-1">
                            <input type="submit" name="Submit" value="Approve" onclick="return validate_vendor()" class="btn btn-primary" />
                        </div>
                        <div class="col-sm-1">
                            <input type="submit" name="DisApprove" value="DisApprove" onclick="return validate_disapprove()" class="btn btn-primary" />
                        </div>
                    </div>
                    <?php 
