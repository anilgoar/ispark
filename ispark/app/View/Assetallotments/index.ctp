...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>Assetallotments/getcostcenter",{BranchName:BranchName}, function(data){
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('Assetallotments',array('action'=>'index','class'=>'form-horizontal')); ?>
				...
				<div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <table class = "table table-striped table-hover  responstable"  >     
                            ...
                            <tbody>         
                                <?php
                                $n=1; foreach ($data as $row){
								$val		=	$row['Masjclrentry'];
                                $EmpCode 	= 	base64_encode($val['EmpCode']);
									
                                ?>
                                <tr>
                                    <td style="text-align: center;"><?php echo $n++;?></td>
                                    <td style="text-align: center;"><?php echo $val['EmpCode'];?></td>
									<td style="text-align: center;"><?php echo $val['EmpLocation'];?></td>
                                    <td ><?php echo $val['EmpName'];?></td>
									<td style="text-align: center;"><?php echo $val['Desgination'];?></td>
                                    <td style="text-align: center;"><?php echo date('d-M-Y',strtotime($val['DOJ']));?></td>
                                    
                                    
                                    <td style="text-align: center;">
                                        <a href="<?php $this->webroot;?>Assetallotments/viewdetails?EC=<?php echo $EmpCode;?>">View</a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>   
