				...
				<?php $case=array('primary',''); $i=0; ?>
					<thead>
						...
						<tr class="<?php  echo $case[$i%4]; $i++;?>">
							...
							<td><code ><?php echo $this->Html->link('Approve',array('controller'=>'Gms','action'=>'approve_imprest_tmp','?'=>array('Id'=>$post['eemApp']['Id']),'full_base' => true)); ?></code></td>
						</tr>
						<?php endforeach; ?>
						<?php unset($data); ?>
					</tbody>
