				...
				<?php $case=array('active',''); $i=0; ?>
					<thead>
						...
						<tr class="<?php  echo $case[$i%4]; $i++;?>" align="center">
							...
							<td><?php echo $this->Html->link('Edit for GRN',array('controller'=>'InitialInvoices','action'=>'edit_forgrn','?'=>array('id'=>$id),'full_base' => true)); ?></td>
						</tr>
						<?php endforeach; ?>
