...
//print_r($inv_particulars); 
 echo $this->Form->create('InitialInvoice',array('class'=>'form-horizontal','action'=>'update_proforma')); 
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
		...
		<td>Month for</td>
            ...
            <tr align="center">
            <td class=""><?php echo $data['InitialInvoice']['branch_name'];  ?></td>
            <td class="danger"><?php echo $data['InitialInvoice']['cost_center']; ?></td>
            <td class=""><?php echo $data['InitialInvoice']['finance_year'];?></td>
            <td class="danger"><?php echo $data['InitialInvoice']['month'];?></td>
            <?php if(strtotime($data['InitialInvoice']['invoiceDate'])>strtotime("2017-06-30")) { ?>
            <td class=""><?php echo $cost_master['CostCenterMaster']['ServiceTaxNo'];?></td>
            <td class=""><?php echo $cost_master['CostCenterMaster']['VendorGSTNo'];?></td>
            <?php } ?>
            </tr>
            ...
            <td class="">
                <?php echo $this->Form->input('InitialInvoice.finance_year', array('options' => $finance_yearNew,'value' => $data['InitialInvoice']['finance_year'],'label' => false,
...
<div class="col-xs-8 col-sm-4">
	...
	<div class="box-content no-padding">
		...
		'onClick'=>"displayDatePicker('data[InitialInvoice][invoiceDate]');")); 
            ...
            <tr class="<?php  echo $case[$i%3]; $i++;?>">
            <th>Proforma No.</th>
            <td><?php	echo $data['InitialInvoice']['proforma_bill_no']; ?></td>
            </tr>
			...
			<div class="box-content no-padding">
                            <table class="table table-striped">
                                ...
                                <?php if($data['InitialInvoice']['app_tax_cal']=='1') { 
                                    ...
                                    if(strtotime($data['InitialInvoice']['invoiceDate'])>strtotime("2017-06-30"))
                                                    {
                                                      if($dataX['GSTType']=='Integrated' && $data['InitialInvoice']['apply_gst']=='1')
                                                      {
                                                    ?>
                                                <tr>
                                                    <th>IGST @ 18%</th>
				...
				array('label'=>false,'value'=>$data['InitialInvoice']['grnd'],'readonly'=>true));?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-3">
                                                    <input type="radio" name="GSTType"  value="IntraState" <?php if($dataX['GSTType']=='IntraState') echo "checked"; ?>>IntraState
                                                    <input type="radio" name="GSTType"  value="Integrated" <?php if($dataX['GSTType']=='Integrated') echo "checked"; ?>>Integrated
                                        </div>
                                    </td>
                                </tr>
                                <?php }  else { ?>
                    ...
                    <?php	echo $this->Form->checkbox('apply_service_tax', array('label'=>false,'checked'=>$data['InitialInvoice']['apply_service_tax']=="1"?true:false,'value'=>$data['InitialInvoice']['apply_service_tax'],'onClick'=>'apply_service_tax()')); ?>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <?php if(in_array('5',$roles)){echo $this->Html->link('  Back',array('action'=>'download_proforma'),array('class'=>'btn btn-primary'));}
                                        else{echo $this->Html->link('Back',array('action'=>'download_proforma'),array('class'=>'btn btn-primary'));}	 ?>
                                    </td>
                                    <td>  
                                    </td>
                                </tr>
