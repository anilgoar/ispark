...
<?php echo $this->Form->create('InitialInvoice',array('class'=>'form-horizontal','action'=>'approve_po')); ?>
			...
			<div class="box-content no-padding">
				...
				<?php $case=array('primary','success','info','danger'); $i=0; ?>
					<tbody>
						...
						array('label'=>false,'class'=>'form-control','value'=>$data['po_no'],'required'=>true)); ?></td></tr>
			...
			<div class="box-content no-padding">
				<table class="table table-striped">
						<thead> <tr><th>Total:</th>					<td><?php echo $data['total'];?></td></tr>
                                                <?php if(strtotime($data['invoiceDate']) > strtotime("2015-11-14")) { if($dataX['GSTType']=='Integrated' && $data['apply_gst']=='1') { ?>
						...
						<tr> <th>Grand Total:</th>			<td><?php echo "<b>".$data['grnd']."</b>";?></td></tr></thead>
							...
							<div class="box-content">
					<div class="col-sm-2"><button type="submit" class="btn btn-success btn-label-left" name='submit' value='approve'><b>Approve</b></div>
					<div class="col-sm-2"><button type="submit" class="btn btn-success btn-label-left" name='reject' value='reject'><b>Reject</b></div>
			</div>
