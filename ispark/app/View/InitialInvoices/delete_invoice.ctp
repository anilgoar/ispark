...
<div class="row">
	<div class="col-xs-12">
		<div class="box">
                    <h4 class="page-header">View & Approve Invoice Reject Approval</h4>
                    ...
                    <?php
                            ...
                            foreach($data as $dt)
                            {
                               ...
                               echo '<td>';
                                ...
                                echo '<a href="'.$this->webroot.'/InitialInvoices/edit_invoice/id='.$dt['InitialInvoice']['id'].'" class="btn btn-primary">View</a> <br/>';
