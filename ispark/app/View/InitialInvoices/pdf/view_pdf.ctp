		...
		<td>
			...
			<tr>
				...
				<?php 	if($tbl_invoice['InitialInvoice']['cost_company_name']=='IDC') 
                                ...
                                ?>
                                    <div><b style="font-size:10px; font-family:Arial, Helvetica, sans-serif;"><?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='IDC') {echo 'CIN : U74900DL2008PTC174898';} else if($tbl_invoice['InitialInvoice']['cost_company_name']=='Pikquick Pvt. Ltd.'){} else  { echo 'U74899DL1990PTC038798';} ?></b></div>
