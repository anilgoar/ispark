		...
		<td>
			...
			<tr>
				...
				<?php if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30") ) { ?> 
                                    <div style="font-size:8px; font-family:Arial, Helvetica, sans-serif;">Branch Add: <?php echo wordwrap($branch_detail['Addbranch']['branch_address'],80,"<br>\n"); ?></div>
                                   <?php }  ?>
				</td>
	...
	<tr>
		...
		<td height="100" valign="top">
			<table cellpadding="0" cellspacing="0" width="130">
                            ...
                            <?php //if( !empty($tbl_invoice['InitialInvoice']['grn_createdate']) && strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>
...
<?php if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30") && $tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd') { ?>
<br/>
<br/>
<br/>
