...
<body style="font-size:12px;  font-family:Arial, Helvetica, sans-serif;">
      <?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='IDC') {echo "<br/><br/><br/><br/><br/><br/>";} ?>
	...
	<tr>
		<td>
			...
			<tr>
				...
				<?php 	if($tbl_invoice['InitialInvoice']['cost_company_name']=='IDC') 
                                        {
                                            echo '<font color="red">ISPARK</font> Dataconnect Pvt. Ltd.';
                                        }
                                        else if($tbl_invoice['InitialInvoice']['cost_company_name']=='Pikquick Pvt. Ltd.')
                                        {
                                            echo 'Pikquick Services Private Limited';
                                        }
                                        else
                                        {
                                            echo $tbl_invoice['InitialInvoice']['cost_company_name'];
                                        }
                                
                                ?>
                                    <div><b style="font-size:10px; font-family:Arial, Helvetica, sans-serif;"><?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='IDC') {echo 'CIN : U74900DL2008PTC174898';} else if($tbl_invoice['InitialInvoice']['cost_company_name']=='Pikquick Pvt. Ltd.'){} else  { echo 'CIN : U74899DL1990PTC038798';} ?></b></div>
...
<br>
<?php 
if($tbl_invoice['InitialInvoice']['cost_company_name']=='Pikquick Pvt. Ltd.')
{ echo 'CIN : U74996DL2016PTC300144';}
else
{
    echo '<br/>';
}
...
<table width="544" border ="1" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td colspan="2"  valign="top">
			...
			<?php echo $tbl_invoice['InitialInvoice']['cost_b_Address5']; ?><br>
                        ...
                        GST No :<?php echo $tbl_invoice['InitialInvoice']['cost_VendorGSTNo']; ?>
		...
		<td  valign="top">
			<table width="130" cellpadding="0" cellspacing="0">
					...
					<?php if($tbl_invoice['InitialInvoice']['cost_GSTType'] && strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>
					...
					<tr><td id = "t06"><b>GRN No</b></td></tr>
                                        <?php //if($tbl_invoice['InitialInvoice']['cost_GSTType'] && strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>
                                        <tr><td id = "t06"><b>GRN Date</b></td></tr>
		...
		<td height="100" valign="top">
			<table cellpadding="0" cellspacing="0" width="130">
					...
					<tr><td id = "t06"><b><?php if($tbl_invoice['InitialInvoice']['approve_grn']=='Yes') echo $tbl_invoice['InitialInvoice']['grn']; ?>&nbsp;</b></td></tr>
                                        <?php //if($tbl_invoice['InitialInvoice']['cost_GSTType'] && !empty($tbl_invoice['InitialInvoice']['grn_createdate']) && strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>
                                        <tr><td id = "t06"><?php if($tbl_invoice['InitialInvoice']['approve_grn']=='Yes') { $grndate=date_create($tbl_invoice['InitialInvoice']['grn_createdate']);
                                            echo date_format($grndate,"d-M-Y"); } ?>&nbsp;</td></tr> 
	...
	<tr>
	<td colspan="5"  valign = "top" style = "height:200">
	<table width="540" height = "200" cellpadding="0" cellspacing="0" >
		<tr>
	...
	<tr>
		...
		<td <?php if($tbl_invoice['InitialInvoice']['bill_no'] == 'abc'){ ?> style="background-image:url(/var/www/html/mascallnetnorth.in/ispark/app/webroot/img/sign4.png);background-repeat: no-repeat; <?php } ?>">
		<b>for <?php    
...
<table>
	<tr>
		<td width="227">
			<?php  if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>  
                    <b> Corporate Address:</b> <?php } ?>102/C-1, Kanchan House,<br/>
                    Karampura Commercial Complex,<br/>
	...
	<tr>
		...
		<td>
			<?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd') echo '<img src="/var/www/html/mascallnetnorth.in/ispark/app/webroot/img/9001.jpg" style="height:74">'; //echo $this->Html->image('9001.jpg', array('fullBase' => true,'height'=>74));?>
		</td>
		<td>
			<?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd') echo '<img src="/var/www/html/mascallnetnorth.in/ispark/app/webroot/img/14001.jpg" style="height:74">';//echo $this->Html->image('14001.jpg', array('fullBase' => true,'height'=>74));?>
		</td>
		<td>
			<?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd') echo '<img src="/var/www/html/mascallnetnorth.in/ispark/app/webroot/img/27001.jpg" style="height:74">'; //echo $this->Html->image('27001.jpg', array('fullBase' => true,'height'=>80));?>
		</td>
