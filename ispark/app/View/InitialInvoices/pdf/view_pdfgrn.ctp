...
<body style="font-size:12px;  font-family:Arial, Helvetica, sans-serif;">
      <?php if($cost_master['CostCenterMaster']['company_name']=='IDC') {echo "<br/><br/><br/><br/><br/><br/>";} ?>
...
<br>
<?php 
if($cost_master['CostCenterMaster']['company_name']=='Pikquick Pvt. Ltd.')
	...
	<tr>
		<td colspan="2"  valign="top">
			...
			<?php echo $cost_master['CostCenterMaster']['b_Address5']; ?><br>
                        ...
                        GST No :<?php echo $cost_master['CostCenterMaster']['VendorGSTNo']; ?>
		...
		<td height="100" valign="top">
			<table cellpadding="0" cellspacing="0" width="130">
					...
					<tr><td id = "t06"><b><?php if($tbl_invoice['InitialInvoice']['approve_grn']=='Yes') echo $tbl_invoice['InitialInvoice']['grn']; ?>&nbsp;</b></td></tr>
                                        <?php if($cost_master['CostCenterMaster']['GSTType'] && !empty($tbl_invoice['InitialInvoice']['grn_createdate']) && strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { ?>
                                        <tr><td id = "t06"><?php  $grndate=date_create($tbl_invoice['InitialInvoice']['grn_createdate']);
