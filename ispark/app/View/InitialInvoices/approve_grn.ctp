...
<?php echo $this->Form->create('InitialInvoice',array('class'=>'form-horizontal','action'=>'approve_grn')); ?>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Approve GRN To Invoice</span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content no-padding">
				...
				<?php $case=array('primary','success','info','danger'); $i=0; ?>
					...
					<tr class="<?php  echo $case[$i%3]; $i++;?>"><th>Bill Date</th><td><?php $date=date_create($data['invoiceDate']); echo date_format($date,"d-M-Y"); ?></td></tr>
						...
						array('label'=>false,'class'=>'form-control','value'=>$data['grn'],'required'=>true)); ?></td></tr>
					</tbody>
				</table>
			...
			<div class="box-content no-padding">
				<table class="table table-striped">
						...
						<tr> <th>Grand Total:</th>			<td><?php echo "<b>".$data['grnd']."</b>";?></td></tr></thead>
							...
							<div class="box-content">
					<div class="col-sm-2"><button type="submit" class="btn btn-success btn-label-left"><b>Approve</b></div>
			</div>
