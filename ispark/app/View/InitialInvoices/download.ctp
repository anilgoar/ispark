		...
		<div class="box">
			...
			<div class="box-content">
					...
					<?php echo $this->Session->flash(); ?>
                                            <?php echo $this->Form->create(array('controller'=>'InitialInvoice','action'=>'download')); ?>
                                            	<div class="form-group has-info has-feedback">
							<label class="col-sm-3 control-label"><b style="font-size:14px"> Select Company </b></label>
                                                        <div class="col-sm-3">
                                                        <?php	echo $this->Form->input('company_name', array('label'=>false,'options'=>$company_master,'empty'=>'Select Company','required'=>false,'class'=>'form-control')); ?>
                                                        </div>    
						<label class="col-sm-3 control-label"><b style="font-size:14px">
							 Select Branch </b></label>
                                                <div class="col-sm-3">
                                                    <?php	echo $this->Form->input('branch_name', array('label'=>false,'options'=>$data,'empty'=>'Select Branch','required'=>false,'class'=>'form-control','onChange'=>'download(this)')); ?>
						</div>
						</div>
                                                <div class="form-group has-info has-feedback">
						...
						<label class="col-sm-3 control-label"><b style="font-size:14px"> Bill No. </b></label>
                                                <div class="col-sm-3">
                                        	<?php	echo $this->Form->input('bill_no', array('label'=>false,'class'=>'form-control','onBlur'=>'download_bybillno(this)')); ?>
						</div>
                                                </div>
                                                    <div class="form-group has-info has-feedback">
