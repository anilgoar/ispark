    ...
    <div class="box" >
        ...
        <div class="box-content box-con">
            ...
            <div class="form-group">
                <label for="pwd" class="control-label col-sm-1">System&nbsp;Type</label>
                <div class="col-sm-2">
                    <select  name="data[AssetsManagements][Location]" id="Location" class="form-control" required="" >
                        ...
                        -->
                        <option <?php if(isset($RowData['Location']) && $RowData['Location']=="Server"){echo "selected='selected'";} ?>  value="Server">Server</option>
                        <option <?php if(isset($RowData['Location']) && $RowData['Location']=="Laptop"){echo "selected='selected'";} ?> value="Laptop" >Laptop</option>
                    </select>
               </div>
			   ...
			   <option <?php if(isset($RowData['Brand']) && $RowData['Brand']=="Lenovo"){echo "selected='selected'";} ?> value="Lenovo">Lenovo</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select name="data[AssetsManagements][MotherBoard]" id="MotherBoard" class="form-control" required="">
                        <option value="">Select</option>
			   <option <?php if(isset($RowData['MotherBoard']) && $RowData['MotherBoard']=="Foxcon"){echo "selected='selected'";} ?> value="Foxcon">Foxcon</option>
			   ...
			   <option <?php if(isset($RowData['MotherBoard']) && $RowData['MotherBoard']=="MSI"){echo "selected='selected'";} ?> value="MSI">MSI</option>
			  ...
			  <option <?php if(isset($RowData['Processor1']) && $RowData['Processor1']=="Dual Core"){echo "selected='selected'";} ?> value="Dual Core">Dual Core</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select name="data[AssetsManagements][Speed]" id="Speed"  class="form-control" required="">
                        <option value="">Select</option>
			   <option <?php if(isset($RowData['Speed']) && $RowData['Speed']=="1.6x GHz"){echo "selected='selected'";} ?> value="1.6x GHz">1.6x GHz</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select name="data[AssetsManagements][PriCard]" id="PriCard" class="form-control">
                        <option value="">Select</option>
			   ...
			   <option <?php if(isset($RowData['PriCard']) && $RowData['PriCard']=="Sangoma"){echo "selected='selected'";} ?> value="Sangoma">Sangoma</option>
                        <option <?php if(isset($RowData['PriCard']) && $RowData['PriCard']=="None"){echo "selected='selected'";} ?> value="None">None</option>
			   <option <?php if(isset($RowData['PriCard']) && $RowData['PriCard']=="VOIP Gateway"){echo "selected='selected'";} ?> value="VOIP Gateway">VOIP Gateway</option>
                    </select>
                </div>
                ...
                <div class="col-sm-2">
                    <select name="data[AssetsManagements][Port]" id="Port" class="form-control">
                        <option value="">Select</option>
                        <option <?php if(isset($RowData['Port']) && $RowData['Port']=="1"){echo "selected='selected'";} ?> value="1">1</option>
                        ...
                        <option <?php if(isset($RowData['Port']) && $RowData['Port']=="None"){echo "selected='selected'";} ?> value="None">None</option>
                    </select>
                </div>
            ...
            <div class="form-group">
			   ...
			   <option <?php if(isset($RowData['SoftwareType']) && $RowData['SoftwareType']=="Linux Mint"){echo "selected='selected'";} ?> value="Linux Mint">Linux Mint</option>
  		          ...
  		          <option <?php if(isset($RowData['SoftwareType']) && $RowData['SoftwareType']=="Ubuntu"){echo "selected='selected'";} ?> value="Ubuntu">Ubuntu</option>
                    </select>
                </div>
                ...
                <div class="col-sm-2">
                    <select name="data[AssetsManagements][OS]" id="OS" class="form-control" required="">
                        ...
                        <option <?php if(isset($RowData['OS']) && $RowData['OS']=="Linux Mint"){echo "selected='selected'";} ?> value="Linux Mint">Linux Mint</option>
                        <option <?php if(isset($RowData['OS']) && $RowData['OS']=="Vicidialnow"){echo "selected='selected'";} ?> value="Vicidialnow">Vicidialnow</option>
			   <option <?php if(isset($RowData['OS']) && $RowData['OS']=="Windows Server"){echo "selected='selected'";} ?> value="Windows Server">Windows Server</option>
			   <option <?php if(isset($RowData['OS']) && $RowData['OS']=="Windows-7"){echo "selected='selected'";} ?> value="Windows-7">Windows-7</option>
			   <option <?php if(isset($RowData['OS']) && $RowData['OS']=="Ubuntu"){echo "selected='selected'";} ?> value="Ubuntu">Ubuntu</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select name="data[AssetsManagements][VendorName]" id="VendorName" class="form-control">
                        ...
                        <option <?php if(isset($RowData['VendorName']) && $RowData['VendorName']=="Mas"){echo "selected='selected'";} ?> value="Mas">Mas</option>
                        <option <?php if(isset($RowData['VendorName']) && $RowData['VendorName']=="PMS"){echo "selected='selected'";} ?> value="PMS">PMS</option>
                        <option <?php if(isset($RowData['VendorName']) && $RowData['VendorName']=="RMV"){echo "selected='selected'";} ?> value="RMV">RMV</option>
