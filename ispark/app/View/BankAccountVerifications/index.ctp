...
<script>
    ...
    $.post("<?php echo $this->webroot;?>BankAccountVerifications/getcostcenter",{BranchName:BranchName}, function(data){
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('BankAccountVerifications',array('action'=>'index','class'=>'form-horizontal')); ?>
                            ...
                            <tbody>         
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php $this->webroot;?>BankAccountVerifications/viewdetails?EC=<?php echo $EmpCode;?>">View</a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>   
