    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>Business Dashboard Mail Schedule</span>
                </div>
                <div class="box-icons">
                ...
                <?php echo $this->Form->create('MailSchedulers',array('class'=>'form-horizontal')); ?>    
                    <table class="table table-bordered data-table" id="table_id">
                        ...
                        <tr>
                            ...
                            <th>
                                <textarea          id="MailCC<?php echo $branchid; ?>"  name="Report[<?php echo $branchid; ?>][ReportCC]" placeholder="Mail CC" class="col-xs-10 col-sm-12"   ><?php echo $MailSchedular[$branch]['ReportCC']; ?></textarea>
                            </th>
                            
                            <th>
                                <textarea          id="MailBCC<?php echo $branchid; ?>" name="Report[<?php echo $branchid; ?>][ReportBCC]" placeholder="Mail BCC" class="col-xs-10 col-sm-12"  ><?php echo $MailSchedular[$branch]['ReportBCC']; ?></textarea>
                            </th>
