...
<div class="col-sm-3">
	<?php	echo $this->Form->input('pay_amount', array('label'=>false,'class'=>'form-control','id'=>'CollectionPayAmount','placeholder' => 'Amount','onkeypress'=>'return isNumberKey(event)','maxlength'=>'9','required'=>true)); ?>
</div>
