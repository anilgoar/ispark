...
//print_r($post);die;
					 echo "<tr class=\"".$case[$i%4]."\">";
					 	echo "<td>".$i++."</td>";
						echo "<td align=\"center\"><code>".$this->Html->link($post['qual_employee']['EmpCode'],array('controller'=>'Jclrs','action'=>'editjclr','?'=>array('id'=>$post['qual_employee']['EmpCode']),'full_base' => true))."</code></td>";
