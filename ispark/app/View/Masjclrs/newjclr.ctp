...
function validate(tab){
	...
	else if(checkDoj(DOJ) ==""){
         $("#DOJ").addClass('bordered'); 
        $("#DOJ").after("<span id='msgerr' class='msger'>DOJ allow only previous 4 day from today.</span>");
        return false;
    }
    else if(NomineeName ===""){
    ...
    /*
        ...
        $("#Type_Of_Employee").addClass('bordered'); 
        $("#Type_Of_Employee").after("<span id='msgerr' class='msger'>Please select type of employee.</span>");
        return false;
    }
    else if(tab =="tab2"){
        $("#JCLRFORM").submit();
    ...
    else if(Experience ==="Experience" && Experience_Doc_Type !="" && Experience_Doc ===""){
        $("#Experience_Doc").addClass('bordered'); 
        $("#Experience_Doc").after("<span id='msgerr' class='msger'>Please upload experience doc.</span>");
        return false;
    }
    else if(Experience ==="Experience" && Experience_Doc_Type ==="" && Expdoc ===""){
        $("#Experience_Doc_Type").addClass('bordered'); 
        $("#Experience_Doc_Type").after("<span id='msgerr' class='msger'>Please select experience doc type.</span>");
        return false;
    }
...
function checkDoj(FromDate){
	
    var posts = $.ajax({type: 'POST',url:"<?php echo $this->webroot;?>Masjclrs/check_doj",async: false,dataType: 'json',data: {FromDate:FromDate},done: function(response) {return response;}}).responseText;	
...
function checkPhoto(target) { 
    ...
    if(target.files[0].size > 9000000) {
        alert('Maximum size of document to upload is 9 mb.');
        document.getElementById("file").value = "";
        return false;
    }
    return true;
...
function get_qualification_details(Qualification){
    ...
    if(Qualification =="UNDER GRADUATE" || Qualification =="OTHER"){
        ...
        $.post("<?php echo $this->webroot;?>Masjclrs/get_qualification_details",{Qualification:Qualification,value:''},function(data){
...
$(document).ready(function(){
    editcity('<?php echo $Jclr['NewjclrMaster']['Passed_Out_City'];?>','<?php echo $Jclr['NewjclrMaster']['Passed_Out_State_Id'];?>','Passed_Out_City');
    <?php if($Jclr['NewjclrMaster']['Qualification'] =="UNDER GRADUATE" || $Jclr['NewjclrMaster']['Qualification'] =="OTHER"){?>
        $("#Qualification_Details_Div").html('<input type="text" name="Qualification_Details"  id="Qualification_Details" value="<?php echo $Jclr['NewjclrMaster']['Qualification_Details'];?>" class="form-control">');
    <?php }else{?>
    $.post("<?php echo $this->webroot;?>Masjclrs/get_qualification_details",{Qualification:'<?php echo $Jclr['NewjclrMaster']['Qualification'];?>',value:'<?php echo $Jclr['NewjclrMaster']['Qualification_Details'];?>'},function(data){
        $("#Qualification_Details_Div").html('<select name="Qualification_Details" id="Qualification_Details" class="form-control">'+data+'</select>');
    });
    <?php }?>  
});
...
function search_reporting(EmpCode){
    var BranchName="<?php echo $Jclr['NewjclrMaster']['BranchName'];?>";
    $.post("<?php echo $this->webroot;?>Masjclrs/get_reporting_manager",{'EmpCode':$.trim(EmpCode),'BranchName':BranchName}, function(data) {
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>JCLR ENTRY DETAILS  <?php echo $TabName;?></span>
                </div>
                <div class="box-icons">
            ...
            <div class="box-content box-con" >
                ...
                <div class="form-group has-info has-feedback">
                    ...
                    <div class="col-sm-3">
                        <select name="Billable_Status" id="Billable_Status" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['NewjclrMaster']['Billable_Status'] =="Yes"){echo "selected='selected'";}?> value="Yes">Yes</option>
                            <option <?php if($Jclr['NewjclrMaster']['Billable_Status'] =="No"){echo "selected='selected'";}?> value="No">No</option>
                        </select>
                    </div>
                </div>
                
                <div class="form-group has-info has-feedback">
                    <label class="col-sm-2 control-label">Search Reporting<span class="req"></span></label>
                    <div class="col-sm-3">
                    ...
                    <label class="col-sm-3 control-label">Reporting Name<span class="req">*</span></label>
                    <div class="col-sm-3">
                        <input type="text" name="Reporting_Manager_Name" id="Reporting_Manager_Name" readonly="" value="<?php echo $Jclr['NewjclrMaster']['Reporting_Manager_Name'];?>" class="form-control"  >
                    </div>
                </div>
                
                <div class="form-group has-info has-feedback">
                    <label class="col-sm-2 control-label">Reporting Mobile No<span class="req">*</span></label>
                    <div class="col-sm-3">
                        <input type="text" name="Reporting_Manager_Mobile_No"  id="Reporting_Manager_Mobile_No" readonly="" value="<?php echo $Jclr['NewjclrMaster']['Reporting_Manager_Mobile_No'];?>" class="form-control"  >
                    </div>
					
					<label class="col-sm-3 control-label">Type Of Employee<span class="req">*</span></label>
                    <div class="col-sm-3">
						<select name="Type_Of_Employee" id="Type_Of_Employee" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['NewjclrMaster']['Type_Of_Employee'] =="BMC"){echo "selected='selected'";}?> value="BMC">BMC</option>
                            <option <?php if($Jclr['NewjclrMaster']['Type_Of_Employee'] =="DSC"){echo "selected='selected'";}?> value="DSC">DSC</option>
							<option <?php if($Jclr['NewjclrMaster']['Type_Of_Employee'] =="AGENT"){echo "selected='selected'";}?> value="AGENT">AGENT</option>
							<option <?php if($Jclr['NewjclrMaster']['Type_Of_Employee'] =="AGENT OS"){echo "selected='selected'";}?> value="AGENT OS">AGENT OS</option>
							<option <?php if($Jclr['NewjclrMaster']['Type_Of_Employee'] =="FIELD"){echo "selected='selected'";}?> value="FIELD">FIELD</option>
                        </select>
					</div>
                </div>
                ...
                <div class="form-group" style="margin-top:30px;">
                    ...
                    <div class="col-sm-3">                     
                        <?php echo $this->Form->input('Qualification', array('label'=>false,'class'=>'form-control','value'=>$Jclr['NewjclrMaster']['Qualification'],'onchange'=>'get_qualification_details(this.value)','id'=>'Qualification','options'=>array('UNDER GRADUATE'=>'UNDER GRADUATE','GRADUATE'=>'GRADUATE','POST GRADUATE'=>'POST GRADUATE','MASTER DEGREE'=>'MASTER DEGREE','ENGINEERING'=>'ENGINEERING','OTHER'=>'OTHER'),'empty'=>'Select')); ?>
                    </div>
                    
                    <label class="col-sm-3 control-label">Qualification Details <span class="req">*</span></label>
                ...
                <div class="form-group has-info has-feedback">
                    <label class="col-sm-2 control-label">Passed Out Year <span class="req"></span></label>
                    <div class="col-sm-3">
                        <select name="Passed_Out_Year"  id="Passed_Out_Year" class="form-control"  >
                            <option value="" >Select</option>
                            <?php for($i=1980;$i<=date("Y");$i++){?>
                            <option <?php if($Jclr['NewjclrMaster']['Passed_Out_Year'] ==$i){echo "selected='selected'";}?> value="<?php echo $i;?>" ><?php echo $i;?></option>
                            <?php }?>
                        </select>
                    </div>
                    
                    <label class="col-sm-3 control-label">Passed Out State <span class="req"></span></label>
                    <div class="col-sm-3">
                        <select name="Passed_Out_State_Id" id="Passed_Out_State_Id" class="form-control" onchange="getcity(this.value,'Passed_Out_City')"   >
                            <option value="" >Select</option>
                            <?php foreach($state as $key=>$val){?>
                             <option <?php if($Jclr['NewjclrMaster']['Passed_Out_State_Id'] ==$key){echo "selected='selected'";}?> value="<?php echo $key;?>" ><?php echo $val;?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group has-info has-feedback">
                    <label class="col-sm-2 control-label">Passed Out City <span class="req"></span></label>
                    <div class="col-sm-3">
                    ...
                    <label class="col-sm-3 control-label">Passed Out % <span class="req"></span></label>
                    <div class="col-sm-3">
                        <select name="Passed_Out_Percent" id="Passed_Out_Percent" class="form-control"  >
                            <option value="" >Select</option>
                            <?php for($i=30;$i<=100;$i++){?>
                            <option <?php if($Jclr['NewjclrMaster']['Passed_Out_Percent'] ==$i){echo "selected='selected'";}?> value="<?php echo $i;?>" ><?php echo $i;?></option>
                            <?php }?>
                        </select>  
                    </div>   
                </div>
                ...
                <div class="form-group has-info has-feedback">
                    <div class="col-sm-11">
                        <input type='button' class="btn btn-info btn-new pull-right" value="Save Details" onclick="validate('tab201');" style="margin-left:5px;" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top:30px;" >
                    <label class="col-sm-2 control-label">Annual Income > Then<span class="req">*</span></label>
                    <div class="col-sm-3">
                        <select name="Family_Annual_Income" id="Family_Annual_Income" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="100000"){echo "selected='selected'";}?> value="100000" >100000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="200000"){echo "selected='selected'";}?> value="200000" >200000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="300000"){echo "selected='selected'";}?> value="300000" >300000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="400000"){echo "selected='selected'";}?> value="400000" >400000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="500000"){echo "selected='selected'";}?> value="500000" >500000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="600000"){echo "selected='selected'";}?> value="600000" >600000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="700000"){echo "selected='selected'";}?> value="700000" >700000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="800000"){echo "selected='selected'";}?> value="800000" >800000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="900000"){echo "selected='selected'";}?> value="900000" >900000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="1000000"){echo "selected='selected'";}?> value="1000000">1000000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="1100000"){echo "selected='selected'";}?> value="1100000" >1100000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="1200000"){echo "selected='selected'";}?> value="1200000" >1200000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="1300000"){echo "selected='selected'";}?> value="1300000" >1300000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="1400000"){echo "selected='selected'";}?> value="1400000" >1400000</option>
                            <option <?php if($Jclr['NewjclrMaster']['Family_Annual_Income'] =="1500000"){echo "selected='selected'";}?> value="1500000" >1500000</option>
                        </select>
                    </div>
                    
                    <label class="col-sm-3 control-label">Count Of Dependents<span class="req">*</span></label>
                    <div class="col-sm-3">
                        <select name="Count_Of_Dependents" id="Count_Of_Dependents" class="form-control"  >
                            <option value="" >Select</option>
                            <?php for($i=1;$i<=10;$i++){?>
                            <option <?php if($Jclr['NewjclrMaster']['Count_Of_Dependents'] ==$i){echo "selected='selected'";}?> value="<?php echo $i;?>" ><?php echo $i;?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                <div class="form-group has-info has-feedback">
                    <div class="col-sm-11">
                        <input type='button' class="btn btn-info btn-new pull-right" value="Save Details" onclick="validate('tab202');" style="margin-left:5px;" >
                    </div>
                </div>
                
                <div class="box-header">
                    <div class="box-name">
                        <span>Working Experience Details</span>
                    </div>
                </div>
                <div class="form-group" style="margin-top:30px;" >
                    ...
                    <div class="col-sm-3">
                        <select name="Experience" id="Experience" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['NewjclrMaster']['Experience'] =="Fresher"){echo "selected='selected'";}?> value="Fresher" >Fresher</option>
                            <option <?php if($Jclr['NewjclrMaster']['Experience'] =="Experience"){echo "selected='selected'";}?> value="Experience" >Experience</option>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <select name="Experience_Year" id="Experience_Year" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['NewjclrMaster']['Experience_Year'] =="0"){echo "selected='selected'";}?> value="0" >0</option>
                            <option <?php if($Jclr['NewjclrMaster']['Experience_Year'] =="0.5"){echo "selected='selected'";}?> value="0.5" >0.5</option>
                            <?php for($i=1;$i<=15;$i++){?>
                            <option <?php if($Jclr['NewjclrMaster']['Experience_Year'] ==$i){echo "selected='selected'";}?> value="<?php echo $i;?>" ><?php echo $i;?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group has-info has-feedback">
                    <label class="col-sm-2 control-label">Experience Doc Type<span class="req"></span></label>
                    <div class="col-sm-3">
                        <select name="Experience_Doc_Type" id="Experience_Doc_Type" class="form-control" >
                            <option value="">Select</option>
                            ...
                            <option value="Reliving">Reliving Letter</option>
                        </select>
                    </div>
                    <input type="hidden"  id="Expdoc" value="<?php echo $Jclr['NewjclrMaster']['Experience_Doc'];?>" >
                    <label class="col-sm-3 control-label">Upload Experience File<span class="req"></span></label>
                    <div class="col-sm-3">
                        <input type="file" name="Experience_Doc" id="Experience_Doc" accept="image/jpg" class="form-control"  >
                    </div>
                </div>
                <?php if($Jclr['NewjclrMaster']['Experience_Doc'] !=""){?>
                <div class="form-group ">
                    ...
                    <div class="col-sm-8">
                        <table class = "table table-striped table-bordered table-hover table-heading no-border-bottom responstable" id="table_id">
                            ...
                            <tbody>
                                <?php $i=1; foreach(explode(",",$Jclr['NewjclrMaster']['Experience_Doc']) as $exp){?>
                                <tr>
                                    <td style="text-align:center;"><?php echo $i++;?></td>
                                    <td style="text-align:center;"><?php echo $Jclr['NewjclrMaster']['OfferNo']?></td>
                                    <td style="text-align:center;"><?php echo explode("_",$exp)[0];?> Letter</td>
                                    <td style="text-align:center;"><span style="text-align:center;" onclick="viewimage('Doc_File/<?php echo $Jclr['NewjclrMaster']['OfferNo']?>/<?php echo $exp;?>')"><i style="font-size:20px;cursor: pointer;" title="view" class="material-icons">pageview</i></span></td>
                                    <?php echo "<td style='text-align:center;' onclick=\"deleteexpimage('{$Jclr['NewjclrMaster']['OfferNo']}','{$exp}','{$Jclr['NewjclrMaster']['id']}')\"><i  style='font-size:20px;cursor: pointer;' title='Delete' class='material-icons'>delete_forever</i></td>";?>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
                ...
                <div class="form-group has-info has-feedback">
                    <div class="col-sm-11">
                        <input type='button' class="btn btn-info btn-new pull-right" value="Save Details" onclick="validate('tab203');" style="margin-left:5px;" >
                    </div>
                </div>
...
function deleteexpimage(emp,file,MasJclrId){
    if(confirm('Are you sure you want to delete this record?')){
        window.location='<?php echo $this->webroot;?>Masjclrs/deleteexpfile?EmpCode='+emp+'&filename='+file+'&MasJclrId='+MasJclrId;
    }
}
