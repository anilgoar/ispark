    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content box-con" >
                ...
                <?php echo $this->Form->create('Masjclrs',array('action'=>'newjclr1','class'=>'form-horizontal','id'=>'JCLRFORM','enctype'=>'multipart/form-data')); ?>
                ...
                <div class="form-group has-info has-feedback">
                    ...
                    <div class="col-sm-3">
                        <img src="<?php echo $this->webroot?>Doc_File/<?php echo $Jclr['NewjclrMaster']['OfferNo']?>/<?php echo $Jclr['NewjclrMaster']['Experience_Doc']?>" style="width:100px;" >
                        <span style="text-align:center;" onclick="viewimage('Doc_File/<?php echo $Jclr['NewjclrMaster']['OfferNo']?>/<?php echo $Jclr['NewjclrMaster']['Experience_Doc']?>')"><i style="font-size:30px;cursor: pointer;" title="view" class="material-icons">pageview</i></span>
                    </div>
                    <?php }?>
                </div>
