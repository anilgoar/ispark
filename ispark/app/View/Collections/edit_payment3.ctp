...
?>
<?php echo $this->Form->create('Collection',array('class'=>'form-horizontal','action'=>'update_payment2','enctype'=>'multipart/form-data')); ?>
<div class="row">
        ...
        <div class="box">
                <div class="box-header">
                        <div class="box-name">
                                ...
                                <span>Collection Edit/Approve</span>
                        </div>
                        <div class="box-icons">
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <table class = "table table-striped table-bordered table-hover table-heading no-border-bottom">
                ...
                <tr>
                        <th>1.</th>
                        <th><?php echo $this->Form->input('bill_no' ,array('label' =>false,'placeholder' => 'Bill No','class' => 'form-control','onkeypress'=>'return isNumberKey(event)','onBlur'=>"get_bill_amount1(this.value);")); ?></th>
...
<table>
						...
						foreach ($result2 as $post): ?>
                            ...
                            <td><?php echo $this->Form->input('OtherDeduction.'.$post['OtherDeductionUpdate']['PaymentId'].'.other_deduction',array('label'=>false,'value'=>$post['OtherDeductionUpdate']['other_deduction'],'class'=>'form-control','onkeypress'=>'return isNumberKey(event)','onBlur'=>'validate_colleciton_amount();')); ?></td>
                        ...
                        <table class="table table-striped table-bordered table-hover table-heading no-border-bottom">
                            ...
                            <tr><th>Always (Net Amount - Cheque/RTGS - Deduction) = 0</th><td class="<?php if(($net-$payment_master['8']-$deduct)!=0){echo "bg-danger";} else{ echo "bg-success";} ?>"><?=$net-$payment_master['8']-$deduct?></tr>
                        </table>
          		...
          		<button onclick="return validate_save_collection();" class="btn btn-success btn-label-left">Approve </button>
				</div>
			</div>
		</div>
	</div>
