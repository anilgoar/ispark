...
function OldHisDelete()
{
    ...
    $.post("get_old_delete",
            ...
            function(data,status){
                if(data=='1')
                {  alertify.success('All Previous Expense has been deleted successfully');  $('#TotalAmount').val('');}
                else
...
<?php echo $this->Form->create('ExpenseEntries',array('class'=>'form-horizontal','action'=>'expense_final_save','enctype'=>'multipart/form-data')); ?>
<div class="box-content" style="background-color:#ffffff">
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-4">
            <div class="input-group">
                <?php echo $this->Form->input('TotalAmount',array('label' => false,'value'=>$data['Amount'],'class'=>'form-control','id'=>'TotalAmount','readonly'=>true,'onkeypress'=>"return isNumberKey(event)",'required'=>true)); ?>
...
<div class="box-content">
    <div class="form-group has-info has-feedback">
        <label class="col-sm-2 control-label" for="form-styles">Payment File</label>
        <div class="col-sm-4">
        <?php echo $this->Form->file('PaymentFile',array('label'=>false,'alt'=>'Select File','accept'=>"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel")); ?>
        </div>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <button name="FinalSave" value="Save" onclick="return expense_check()" class="btn btn-info">Save</button> 
        </div>
...
echo $this->Form->input('qry',array('label'=>false,'type'=>'hidden', 'value'=>$qry,'id'=>'qry'));
