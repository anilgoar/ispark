...
<?php echo $this->Form->create('ExpenseEntries',array('class'=>'form-horizontal','action'=>'bm_final_save','enctype'=>'multipart/form-data')); ?>
...
<div class="box-content">
   <div class="form-group has-info has-feedback">
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-2">
            <a href="<?php echo $this->webroot.'ExpenseEntries/discard?action=view_bm&id='.$data['Id'];?>" class="btn btn-info">Disapprove</a>
        </div>
    </div>
    <div class="clearfix"></div> 
</div>
