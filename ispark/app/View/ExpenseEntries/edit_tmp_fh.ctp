...
<?php echo $this->Form->create('ExpenseEntries',array('class'=>'form-horizontal','action'=>'fh_final_save','enctype'=>'multipart/form-data')); ?>
    ...
    <div class="form-group has-info has-feedback">
        ...
        <div class="col-sm-4">
            <div class="input-group">
                <?php echo $this->Form->input('head',array('label' => false,'options'=>$head,'empty'=>'Select','value'=>$data['HeadId'],'class'=>'form-control','id'=>'head','disabled'=>true)); ?>
        ...
        <div class="col-sm-4">
            <div class="input-group">
                <?php echo $this->Form->input('subHead',array('label' => false,'options'=>$Subhead,'value'=>$data['SubHeadId'],'class'=>'form-control','id'=>'subHead','disabled'=>true)); ?>
...
<div class="box-content">
    ...
    <div class="form-group has-info has-feedback">
        <div class="col-sm-2">
            <button name="FinalSave" value="Save" onclick="return expense_check()" class="btn btn-info">Approve</button> 
        </div>
        <div class="col-sm-2">
            <a href="<?php echo $this->webroot.'ExpenseEntries/discard?action=view_fh&id='.$data['Id'];?>" class="btn btn-info">Disapprove</a>
        </div>
    </div>
    <div class="clearfix"></div> 
</div>
