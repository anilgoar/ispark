...
$disabled   =   $this->Session->read('role')=='admin' && $this->Session->read('branch_name') =="HEAD OFFICE"?"":"disabled";
?>
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content box-con" >
                ...
                <?php echo $this->Form->create('EditMasjclrs',array('action'=>'newjclr','class'=>'form-horizontal','id'=>'JCLRFORM','enctype'=>'multipart/form-data')); ?>
                ...
                <div class="form-group has-info has-feedback">
                    ...
                    <div class="col-sm-3">
                        <select name="Desgination" id="Desgination" class="form-control" onchange="getdesg(this.value,'Band')" <?php echo $disabled;?>  >
                            <option value="" >Select</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group has-info has-feedback">
                    ...
                    <div class="col-sm-3">
						<select name="Type_Of_Employee" id="Type_Of_Employee" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['Masjclrentry']['Type_Of_Employee'] =="BMC"){echo "selected='selected'";}?> value="BMC">BMC</option>
                            <option <?php if($Jclr['Masjclrentry']['Type_Of_Employee'] =="DSC"){echo "selected='selected'";}?> value="DSC">DSC</option>
							<option <?php if($Jclr['Masjclrentry']['Type_Of_Employee'] =="AGENT"){echo "selected='selected'";}?> value="AGENT">AGENT</option>
							<option <?php if($Jclr['Masjclrentry']['Type_Of_Employee'] =="AGENT OS"){echo "selected='selected'";}?> value="AGENT OS">AGENT OS</option>
							<option <?php if($Jclr['Masjclrentry']['Type_Of_Employee'] =="FIELD"){echo "selected='selected'";}?> value="FIELD">FIELD</option>
                        </select>
					</div>
                </div>
                ...
                <div class="form-group" style="margin-top:30px;" >
                    ...
                    <div class="col-sm-3">
                        <select name="Experience_Year" id="Experience_Year" class="form-control"  >
                            <option value="" >Select</option>
                            <option <?php if($Jclr['Masjclrentry']['Experience_Year'] =="0"){echo "selected='selected'";}?> value="0" >0</option>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-8">
                        <table class = "table table-striped table-bordered table-hover table-heading no-border-bottom responstable" id="table_id">
                            ...
                            <tbody>
                                <?php $i=1; foreach(explode(",",$Jclr['Masjclrentry']['Experience_Doc']) as $exp){?>
                                <tr>
                                    <td style="text-align:center;"><?php echo $i++;?></td>
                                    <td style="text-align:center;"><?php echo $Jclr['Masjclrentry']['OfferNo']?></td>
                                    <td style="text-align:center;"><?php echo explode("_",$exp)[0];?> Letter</td>
                                    <td style="text-align:center;"><span style="text-align:center;" onclick="viewimage('Doc_File/<?php echo $Jclr['Masjclrentry']['OfferNo']?>/<?php echo $exp;?>')"><i style="font-size:20px;cursor: pointer;" title="view" class="material-icons">pageview</i></span></td>
                                    <?php echo "<td style='text-align:center;' onclick=\"deleteexpimage('{$Jclr['Masjclrentry']['OfferNo']}','{$exp}','{$Jclr['Masjclrentry']['id']}')\"><i  style='font-size:20px;cursor: pointer;' title='Delete' class='material-icons'>delete_forever</i></td>";?>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
                ...
                <input type="hidden" id="validate_status" name="validate_status" >
...
function deleteexpimage(emp,file,MasJclrId){
    if(confirm('Are you sure you want to delete this record?')){
        window.location='<?php echo $this->webroot;?>EditMasjclrs/deleteexpfile?EmpCode='+emp+'&filename='+file+'&MasJclrId='+MasJclrId;
    }
}
