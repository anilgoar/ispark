                        ...
                        <table class = "table table-striped table-hover  responstable"  >     
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $row['Ticket_Status_Remarks']?>
                                    </td>
                                    <td>
                                        <?php echo $row['Replacement_Serial_No']?>
                                        <?php echo $row['Replacement_Reason']?>
                                    </td>
                                    <td><span class='icon' ><i data-toggle="modal" data-target="#basicExampleModal" onclick="show_details('<?php echo $row['Id'];?>','<?php echo $row['Assets_Form_Id']?>');"  class="material-icons" style="font-size:20px;cursor: pointer;" >edit</i></td>
                                </tr>
                                <?php }?>
                            </tbody>
                        </table>
