...
<?php $this->Form->create('Add',array('controller'=>'AddInvParticular','action'=>'view')); ?>
	...
	<div class="form-group has-success has-feedback">
		<label class="col-sm-2 control-label"><b style="font-size:14px"> Report Name </b></label>	
			<div class="col-sm-2">
				<?php	echo $this->Form->input('Select Report', array('label'=>false,'options'=>array('Ptp Report'=>'Ptp Report','Submission Report'=>'Submission Report'),'empty'=>'Select','class'=>'form-control')); ?>
               
			</div>

		<label class="col-sm-2 control-label"><b style="font-size:14px">  Company </b></label>	
			<div class="col-sm-2">
			...
			<div class="col-sm-2">
            <div id ="mm">
				<?php	echo $this->Form->input('branch_name', array('label'=>false,'options'=>'','empty'=>'Select','class'=>'form-control','onChange'=>'get_report6(this.value')); ?>
                </div>
			</div>			
