...
echo $this->Form->create('Gms',array('class'=>'form-horizontal','action'=>'save_imprest_process_head','enctype'=>'multipart/form-data'));
...
<div class="col-xs-12 col-sm-12">
    <div class="box">
        ...
        <div class="box-content" style="background-color:#ffffff; border:1px solid #436e90;">
            <h4 class="page-header textClass" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Edit Reject Imprest(From Approval) <?php echo $this->Session->flash(); ?></h4>
