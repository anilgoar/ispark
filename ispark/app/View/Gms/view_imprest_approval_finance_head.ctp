			...
			<div class="box-content">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="button" name="Search" value="Search" onclick="return get_reject_imprest_record()" class="btn btn-info" />
...
function get_reject_imprest_record()
{
    ...
    $.post("get_imprest_approval_finance_head",
            {
             branch:branch,
             year: year
            },
