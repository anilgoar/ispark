...
<div class="col-xs-12 col-sm-12">
    <div class="box">
        ...
        'Jul'=>'Jul','Aug'=>'Aug','Sep'=>'Sep','Oct'=>'Oct','Nov'=>'Nov','Dec'=>'Dec'),'empty' => 'Select Month','value'=>$ExpenseEntryMaster[1],'label' => false,'id'=>'FinanceMonth', 'div' => false,'class'=>'form-control','selected' => $ExpenseMaster['1'],'readonly'=>$readonly)); ?>
            ...
            <div class="col-sm-4">
                <?php echo $this->Form->input('gst_enable',array('label' => false,'options'=>array('1'=>'Yes','0'=>'No'),'class'=>'form-control','empty'=>'Select','onChange'=>'getEnableStatus(this.value)','value'=>$ExpenseEntryMaster[14],'id'=>'gstEnable','required'=>true,'readonly'=>$readonly)); ?>
            </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->input('Vendor_State_Code',array('label' => false,'options'=>$ExpenseEntryMaster[14]==1?$StateCode:array(),'class'=>'form-control','empty'=>'Select','value'=>$ExpenseEntryMaster[16],'id'=>'Vendor_State_Code','readonly'=>$readonly)); ?>
                </div>
                
                <label class="col-sm-2 control-label">Billing State Code</label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('Billing_State_Code',array('label' => false,'options'=>$ExpenseEntryMaster[14]==1?$StateCode:array(),'class'=>'form-control','empty'=>'Select','value'=>$ExpenseEntryMaster[17],'id'=>'Billing_State_Code','readonly'=>$readonly)); ?>
                </div>
            </div>
        ...
        <div class="form-group has-info has-feedback">
            ...
            <div class="col-sm-4">
                    ...
                    if(!empty($ExpenseEntryMaster[15]))
                    {
                        $due_date = explode('-',$ExpenseEntryMaster[15]);
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<h4 class="page-header" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Details Entry</h4>
                    ...
                    <tr <?php foreach ($result as $post): $GTotal1 += $post['teep']['Total'];endforeach;  if(empty($ExpenseEntryMaster)) {  ?> style="display: none" <?php } else if($GTotal1==$ExpenseEntryMaster[7]) { ?> style="display: none" <?php } ?> >
                        ...
                        <th><?php  if($ExpenseEntryMaster[14]=='1') $gst_en="1"; else { $gst_en="0";}  
                        echo $this->Form->input('amount' ,array('label' =>false,'placeholder' => 'Amount','onBlur'=>"getTotalCostAmount('$gst_en','$ExpenseEntryMaster[16]','$ExpenseEntryMaster[17]')",'class' => 'form-control','onKeypress'=>'return isNumberKey(event)')); ?></th>
                        <th>
                        <?php if($ExpenseEntryMaster[14]=='1') { ?>
                        <?php 
                        echo $this->Form->input('Rate' ,array('label' =>false,'empty' => 'Select','options'=>array('5'=>'5%','12'=>'12%','18'=>'18%','28'=>'28%'),'class' => 'form-control','onChange'=>"getTotalCostAmount('$gst_en','$ExpenseEntryMaster[16]','$ExpenseEntryMaster[17]');",'onKeypress'=>'return isNumberKey(event)')); ?>
                        <?php } else {
                    ...
                    foreach ($result as $post): 
                        ...
                        $idx.=$post['teep']['Id'].','; ?>
                            ...
                            <td>
                                <?php 
                                if($ExpenseEntryMaster[14]=='1'  && $ExpenseEntryMaster[16]!=$ExpenseEntryMaster[17]){ 
                                    echo "CGST@".round($post['teep']['Rate']/2,2)."%"; echo "<br/>"; echo "SGST@".round($post['teep']['Rate']/2,2)."%"; 
                                } 
                                else if( $ExpenseEntryMaster[14]=='1'){ 
