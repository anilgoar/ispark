...
<div class="col-xs-12 col-sm-12">
    <div class="box">
        ...
        <div class="box-content" style="background-color:#ffffff; border:1px solid #436e90;">
            <h4 class="page-header textClass" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Imprest GRN Entry <font color="green"><?php echo $this->Session->flash(); ?></font></h4>
        ...
        <div class="form-group">						
            ...
            <div class="col-sm-2">
                ...
                <?php echo $this->Html->link('Reset',array('action'=>'back1'),array('class'=>'btn btn-primary')); ?>
            </div>
        </div>
        </div>
    </div>
		...
		<h4 class="page-header" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Details Entry</h4>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                       ...
                       'class'=>'form-control','id'=>'grn_file','value'=>'','required'=>true,'accept'=>"image/x-png,image/gif,image/jpeg")); ?>
                    </div>
                </div>
                <div class="form-group">
