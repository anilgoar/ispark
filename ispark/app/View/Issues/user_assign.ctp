				...
				<?php $case=array('primary','success','info','warning','danger'); $i=0; ?>
					<tbody>
						...
						<tr class="<?php  echo $case[$i%4]; $i++;?>" align="center">
							<?php $id= $post['IssueParticular']['id']; ?>
							<td><code><?php echo $i; ?></code></td>
                            <td><code><?php echo $post['IssueParticular']['id']; ?></code></td>
                            <td><code><?php echo $post['IssueParticular']['branch_name']; ?></code></td>
							...
							<td>
								<code><?php echo $this->Html->link('user_issue',
							array('controller'=>'Issues','action'=>'user_issue','?'=>array('id'=>$id),'full_base' => true)); ?></code>
						</td>
						</tr>
						<?php endforeach; ?>
						<?php unset($Issues); ?>
