...
function chequeNoExist(PrintCheckFrom,PrintCheckTo,PrintBankName){
    var posts = $.ajax({type: 'POST',url:"<?php echo $this->webroot;?>ChequePrints/chequenoexistpremonth",async: false,dataType: 'json',data: {PrintCheckFrom:PrintCheckFrom,PrintCheckTo:PrintCheckTo,PrintBankName:PrintBankName},done: function(response) {return response;}}).responseText;	
    return posts;
}
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>SALARY PRINT (pre month)</span>
		</div>
		<div class="box-icons">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <select id="EmpMonth" name="EmpMonth" autocomplete="off" class="form-control" readonly >
                            ...
                            <option value="<?php echo date('m', strtotime(date('Y-m')." -3 month"));?>"><?php echo date('M', strtotime(date('Y-m')." -3 month"));?></option>
                            <option value="<?php echo date('m', strtotime(date('Y-m')." -4 month"));?>"><?php echo date('M', strtotime(date('Y-m')." -4 month"));?></option>
                            <option value="<?php echo date('m', strtotime(date('Y-m')." -5 month"));?>"><?php echo date('M', strtotime(date('Y-m')." -5 month"));?></option>
                            <option value="<?php echo date('m', strtotime(date('Y-m')." -6 month"));?>"><?php echo date('M', strtotime(date('Y-m')." -6 month"));?></option>
                            <option value="<?php echo date('m', strtotime(date('Y-m')." -7 month"));?>"><?php echo date('M', strtotime(date('Y-m')." -7 month"));?></option>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <select id="EmpYear" name="EmpYear" autocomplete="off" class="form-control" readonly >
                            <option value="<?php echo date('Y', strtotime(date('Y-m')." -2 month"));?>"><?php echo date('Y', strtotime(date('Y-m')." -2 month"));?></option>
                        </select>
                    </div>
