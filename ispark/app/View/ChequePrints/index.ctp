...
function printed(BranchName,CostCenter,EmpLocation,EmpCode,EmpMonth,EmpYear){            
    $.post("<?php echo $this->webroot;?>ChequePrints/printdetailsc",{BranchName:BranchName,EmpMonth:EmpMonth,EmpYear:EmpYear,CostCenter:CostCenter,EmpLocation:EmpLocation,EmpCode:$.trim(EmpCode)}, function(data) {
        $("#divPrint").show();
        $("#divPrint").html(data);
        $("#divEmp").hide();
        $("#divEmp").html('');
