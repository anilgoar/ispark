    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <span>Salary Upload Branch Wise</span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content">
                ...
                <?php if($activity=='upload') {  ?>
                    <div class="form-group">
                    <label class="col-sm-2 control-label">Branch</label> 
                    <div class="col-sm-4">
                       <?php	
                    echo $this->Form->input('BranchId', array('label'=>false,'id'=>'BranchId','empty'=>"Select",'class'=>'form-control','options'=>$branch_master,'onchange'=>"get_dash()",'required'=>true));
                    ?> 
                    </div>
                    ...
                    <div class="col-sm-2">
                       <?php	
                    echo $this->Form->input('FinanceYear', array('label'=>false,'id'=>'FinanceYear','empty'=>"Select",'class'=>'form-control','options'=>$financeYearArr,'onchange'=>"get_dash()",'required'=>true));
                    ?> 
                    </div>
                ...
                <?php } ?>
                <?php  if($activity=='check') {  ?>
                <div class="form-group">
                    <?php echo $html; ?>
                </div>
                <div class="form-group">
                    <div class="col-sm-2">
                <?php if(empty($error)) { ?> <input type="Submit" name="Submit" value="Save" class="btn btn-primary btn-label-left" /> <?php } ?>
                        <input type="Submit" name="Submit" value="Reject" class="btn btn-primary btn-label-left" />
                    </div>
		</div>
                <?php } ?>
		<div class="clearfix"></div>
            ...
            <div class="col-sm-3">    
            <div class="box-content" id="salary_upload_check">
                <table border="2">
                    <tr>
                        <th>Branch</th>
                        <th>Status</th>
