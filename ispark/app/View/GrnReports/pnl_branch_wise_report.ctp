...
function DashboardLog(Id){
    $.post("<?php echo $this->webroot;?>GrnReports/pnl_branch_wise_report",{Id:Id},function(data){
    });
}
</script>
<style>
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    ...
                    <span>P&L Branch Wise Report</span>
		</div>
		<div class="box-icons">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <?php	$month = array('Jan'=>'Jan','Feb'=>'Feb','Mar'=>'Mar','Apr'=>'Apr','May'=>'May','Jun'=>'Jun','Jul'=>'Jul','Aug'=>'Aug','Sep'=>'Sep','Oct'=>'Oct','Nov'=>'Nov','Dec'=>'Dec');
                                echo $this->Form->input('FinanceMonth', array('label'=>false,'id'=>'Month','class'=>'form-control','options' => $month,'empty' => 'Select','required'=>true));
                            ?>
                        </div>
                    </div>
...
<script>
	...
	else if(Month =='')
	{
       ...
       var url='http://mascallnetnorth.in/ispark/GrnReports/get_pnl_report_branch_wise?Company='+Company+'&FinanceYear='+Year+'&FinanceMonth='+Month+'&type='+'Export';
