		...
		<h4 class="page-header" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Details Entry</h4>
                    ...
                    foreach ($result as $post): 
                        ...
                        $idx.=$post['teep']['Id'].','; ?>
                            ...
                            <td><?php if($ExpenseEntryMaster[14]=='Yes' && $gstType['0']['tscgd']['GSTEnable']=='1' && $gstType['0']['0']['GSTType']=='state'){ echo "CGST@".round($post['teep']['Rate']/2,2)."%"; echo "<br/>"; echo "SGST@".round($post['teep']['Rate']/2,2)."%"; } else if($gstType['0']['tscgd']['GSTEnable']=='1' && $gstType['0']['0']['GSTType']=='central'){ echo "IGST@".round($post['teep']['Rate'])."%";} else {  echo $post['teep']['Rate']; } ?></td>
<!--                            <td><?php //echo $post['teep']['Tax'];?></td>-->
                            <td><?php if($ExpenseEntryMaster[14]=='Yes' &&  $gstType['0']['tscgd']['GSTEnable']=='1' && $gstType['0']['0']['GSTType']=='state'){ echo round($post['teep']['Tax']/2,3); echo "<br/>"; echo round($post['teep']['Tax']/2,3); } else if($gstType['0']['tscgd']['GSTEnable']=='1' && $gstType['0']['0']['GSTType']=='central'){ echo round($post['teep']['Tax'],2);} else {  echo $post['teep']['Rate']; } ?></td>
