    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>Qualification MASTER</span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <div class="form-group"> 
                    <label class="col-sm-1 control-label">Qualification</label>
                    <div class="col-sm-2">
                        <?php echo $this->Form->input('Qualification', array('label'=>false,'class'=>'form-control','value'=>$Jclr['NewjclrMaster']['Qualification'],'id'=>'Qualification','options'=>array('UNDER GRADUATE'=>'UNDER GRADUATE','GRADUATE'=>'GRADUATE','POST GRADUATE'=>'POST GRADUATE','MASTER DEGREE'=>'MASTER DEGREE','ENGINEERING'=>'ENGINEERING'),'empty'=>'Select','required'=>true)); ?>
                    </div>
                    
                    <label class="col-sm-2 control-label">Qualification&nbsp;Details</label>
                    <div class="col-sm-4">
