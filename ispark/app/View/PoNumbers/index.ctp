...
function getCostCenter(val)
{
    ...
    $.post("PoNumbers/get_client",{branch_name:val},function(data)
    {$("#client_id").html(data);});
}
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
		...
		<h4 class="page-header"><?php echo $this->Session->flash(); ?></h4>
                ...
                'poNumber'=>'PO Number','image_upload'=>'Image Upload');
                ...
                for($i=0; $i<count($keys); $i++)
                {
                    ...
                    else if($keys[$i]=='periodTo' || $keys[$i]=='periodFrom')
                    {
                        ...
                        $array[$keys[$i]],'class'=>'form-control','type'=>'text','required'=>true,'onClick'=>"displayDatePicker('data[PoNumber][{$keys[$i]}]');"));
                        echo "</div>";
                    }
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <span>Escalation 1 For 30 Days Before PoNumber Ends</span>
		</div>
            <div class="box-icons">
            	<a class="collapse-link">
		<i class="fa fa-chevron-up"></i>
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <span>Escalation 2 For 15 Days Before PoNumber Ends</span>
		</div>
            <div class="box-icons">
            	<a class="collapse-link">
		<i class="fa fa-chevron-up"></i>
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <span>Escalation 3 After PoNumber Ends For Every Monday & Thursday</span>
		</div>
            <div class="box-icons">
            	<a class="collapse-link">
		<i class="fa fa-chevron-up"></i>
