		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <div class="form-group">
                    ...
                    <a href="#" style="margin-left:20px;text-decoration:underline;" onclick="get_disp('<?php echo $pageHeader;?>')"><?php echo $pageHeader;?></a>
                    
                <div id="<?php echo $pageHeader; ?>" style="display:none">
