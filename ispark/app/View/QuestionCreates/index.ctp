...
<?php echo $this->Form->create('QuestionCreates',array('class'=>'form-horizontal','url'=>'save_paragraph')); ?>
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<h4 class="page-header"><?php echo $this->Session->flash(); ?></h4>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="head_name" name="head_name" class="form-control" placeholder="Write Name Here" required="" />
                    </div>
                    <label class="col-sm-1 control-label">Time</label>
                    <div class="col-sm-2">
                        <input type="text" id="para_time" name="para_time" class="timepicker" placeholder="0" required="" />
                    </div>
                    <label class="col-sm-1 control-label">Pass %</label>
                    <div class="col-sm-1">
                        <input type="text" id="passing_mark" name="passing_mark" class="form-control" placeholder="0" onkeypress="return checkNumber(this.value,event)" required="" />
                    </div>
                </div>
                <div class="form-group">    
                    <label class="col-sm-2 control-label">ParaGraph</label>
                    <div class="col-sm-8">
                        <textarea id="para_id" name="para_id" class="form-control" placeholder="write your paragraph here..." rows="4"></textarea>
                    </div>
                </div>
                <h4 class="page-header">Add New Question</h4>
                <table id="tbl1" class = "table table-striped table-bordered table-hover table-heading no-border-bottom responstable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="marks" name="marks" class="form-control" style="width:40px;" onkeypress="return checkNumber(this.value,event)" maxlength="2" placeholder="0"  />&nbsp;&nbsp;
                            </td>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <input type="submit" value="Save" class="btn btn-primary btn-new pull-center" />
                    </div>
                </div>
