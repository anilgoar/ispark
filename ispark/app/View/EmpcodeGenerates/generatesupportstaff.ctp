    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>GENERATE EMP CODE (SUPPORT STAFF) </span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('EmpcodeGenerates',array('class'=>'form-horizontal','action'=>'generatesupportstaff','id'=>'showDetails')); ?>
