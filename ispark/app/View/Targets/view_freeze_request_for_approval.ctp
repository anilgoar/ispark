		...
		<table border="2" class = "table table-striped table-hover  responstable">
                     <thead>
                        <tr style="text-align:center">
                            ...
                            <td colspan="4"><b>OP%</b></td>
                            <td rowspan="4" colspan="2"><b>Action Approve</b></td>
                   ...
                   <tbody>
                        <?php $i=1; $Total=0;//print_r($ExpenseReport);
                                foreach($data as $dt)
                                {
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>".round($dt['0']['Rev_Com'],2)."</td>";$totalArray['Rev_Com'] +=round($dt['0']['Rev_Com'],2);
                                        ...
                                        echo "<td>".round($dt['0']['Dir_Com'],2)."</td>";$totalArray['Dir_Com'] +=round($dt['0']['Dir_Com'],2);
                                        ...
                                        echo "<td>".round($dt['0']['InDir_Com'],2)."</td>";$totalArray['InDir_Com'] +=round($dt['0']['InDir_Com'],2);
                                        ...
                                        echo "<td>".round($dt['0']['Rev_Com']-$dt['0']['Dir_Com']-$dt['0']['InDir_Com'],2)."</td>";
                                        ...
                                        echo "<td>".round(($dt['0']['Rev_Com']-$dt['0']['Dir_Com']-$dt['0']['InDir_Com'])*100/$dt['0']['Rev_Com'],2)."%</td>";
                       ...
                       <tr>
                        ...
                        <?php
                            ...
                            echo "<td>".round($totalArray['Rev_Com']-$totalArray['Dir_Com']-$totalArray['InDir_Com'],2)."</td>";
                            ...
                            echo "<td>".round(($totalArray['Rev_Com']-$totalArray['Dir_Com']-$totalArray['InDir_Com'])*100/$totalArray['Rev_Com'],2)."%</td>";
