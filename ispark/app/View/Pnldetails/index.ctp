		...
		<div class="box-icons">
            ...
            <div class="box-content" style="overflow: auto;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php echo $this->Form->input('ForPnlType',array('label'=>false,'id'=>'ForPnlType','options'=>array('Branch'=>'P&L Branch Wise','Process'=>'P&L Process Wise','Both'=>'P&L Both Branch & Process Wise','Branch-Month'=>'Branch Month Wise','Process-Month'=>'Month Process Wise'),'empty'=>'Select','required'=>true,'onchange'=>'validate_pnl(this.value)','class'=>'form-control')); ?>
                    </div>
                </div>
                <div class="form-group">
...
<script>
         function validate_pnl(value)
         {
             ...
             else if(value=='Process-Month')
             {
                options += '<option value="Process">Process Wise</option>';
             }
             else if(value=='Branch-Month')
             {
                 options += '<option value="Branch">Branch Wise</option><option value="Process">Process Wise</option>';
             }
