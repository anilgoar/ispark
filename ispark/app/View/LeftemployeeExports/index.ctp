...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>LeftemployeeExports/getcostcenter",{BranchName:BranchName}, function(data){
...
function attendanceReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>LeftemployeeExports/show_report",{BranchName:BranchName,EmpMonth:EmpMonth,EmpYear:EmpYear,CostCenter:CostCenter}, function(data) {
                $("#loder").hide();
                if(data !=""){
            ...
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>LeftemployeeExports/export_report?BranchName="+BranchName+"&EmpMonth="+EmpMonth+"&EmpYear="+EmpYear+"&CostCenter="+CostCenter;  
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>LEFT EMPLOYEE REPORT</span>
		</div>
		<div class="box-icons">
