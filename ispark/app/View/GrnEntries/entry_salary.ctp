...
<?php echo $this->Form->create('GrnEntries',array('class'=>'form-horizontal','action'=>'salary_save')); ?>
<div class="box-content" style="background-color:#ffffff">
    <h4 class="page-header textClass">Salary Entry</h4>
...
<div class="box-content">
    <div class="form-group has-info has-feedback">
        <div class="col-sm-2">
            <button name="FinalSave" value="Save" onclick="return validate_salary()" class="btn btn-info">Submit</button> 
        </div>
        <div class="col-sm-2">
