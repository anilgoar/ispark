...
function loanReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>OdReports/show_report",{BranchName:BranchName,StartDate:StartDate,Status:Status,EmpCode:$.trim(EmpCode)}, function(data) {
                $("#loder").hide();
                if(data !=""){
                    $("#divLoan").html(data);
                }
            ...
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>OdReports/export_report?BranchName="+BranchName+"&StartDate="+StartDate+"&Status="+Status+"&EmpCode="+$.trim(EmpCode);  
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('OdReports',array('action'=>'loandetails','class'=>'form-horizontal')); ?>
