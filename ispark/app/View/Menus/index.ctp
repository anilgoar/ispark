            ...
            <div class="box-content box-con">
                ...
                <div class="form-group">
                    <?php foreach($pagelist as $row){?>
                        <?php if (in_array($row['pages_master']['id'], $access)){?>
                            <div class="col-sm-3"><input type="radio" name="MENU" onclick="redirect('<?php echo $row['pages_master']['page_url'] ?>')"> <?php echo $row['pages_master']['page_name'] ?></div>
                        <?php }?>   
                    <?php } ?>     
                </div>
