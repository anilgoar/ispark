...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>DeductionReports/getcostcenter",{BranchName:BranchName}, function(data){
...
function descardReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>DeductionReports/show_report",{BranchName:BranchName,StartDate:StartDate,CostCenter:CostCenter}, function(data) {
                $("#loder").hide();
                if(data !=""){
            ...
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>DeductionReports/export_report?BranchName="+BranchName+"&StartDate="+StartDate+"&CostCenter="+CostCenter;  
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('DeductionReports',array('action'=>'index','class'=>'form-horizontal','id'=>'showDetails')); ?>
