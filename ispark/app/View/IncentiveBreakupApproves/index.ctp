...
function incentiveBreakupDetails(){
    ...
    if(BranchName ===""){
        ...
        $.post("<?php echo $this->webroot;?>IncentiveBreakupApproves/showbreakupdetails",{BranchName:BranchName,CostCenter:CostCenter,SalaryMonth:SalaryMonth}, function(data) {
            if(data !=""){
...
function getBranch(BranchName){
    $.post("<?php echo $this->webroot;?>IncentiveBreakupApproves/getcostcenter",{BranchName:BranchName}, function(data) {
