...
function getBranch(BranchName){ 
    $.post("<?php echo $this->webroot;?>WorkHomeAttendanceExports/getcostcenter",{BranchName:BranchName}, function(data){
...
function attendanceReport(Type){ 
    ...
    if(BranchName ===""){
        ...
        $("#loder").show();
        if(Type ==="show"){
            $.post("<?php echo $this->webroot;?>WorkHomeAttendanceExports/show_report",{BranchName:BranchName,EmpMonth:EmpMonth,EmpYear:EmpYear,CostCenter:CostCenter,EmpLocation:EmpLocation,EmpCode:$.trim(EmpCode)}, function(data) {
                $("#loder").hide();
                if(data !=""){
            ...
            $("#loder").hide();
            window.location="<?php echo $this->webroot;?>WorkHomeAttendanceExports/export_report?BranchName="+BranchName+"&EmpMonth="+EmpMonth+"&EmpYear="+EmpYear+"&CostCenter="+CostCenter+"&EmpLocation="+EmpLocation+"&EmpCode="+$.trim(EmpCode);  
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header"  >
                <div class="box-name">
                    <span>WORK HOME ATTENDANCE EXPORT</span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('WorkHomeAttendanceExports',array('action'=>'index','class'=>'form-horizontal')); ?>
                    ...
                    <div class="col-sm-2">
                        <select id="EmpLocation" name="EmpLocation" autocomplete="off" class="form-control" >
                           <!-- <option value="ALL">ALL</option>
                            ...
                            <option value="Field">Work Home</option>
