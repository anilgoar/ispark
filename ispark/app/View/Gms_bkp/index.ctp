    ...
    <div class="box">
        ...
        'Jul'=>'Jul','Aug'=>'Aug','Sep'=>'Sep','Oct'=>'Oct','Nov'=>'Nov','Dec'=>'Dec'),'empty' => 'Select Month','value'=>$ExpenseEntryMaster[1],'label' => false,'id'=>'FinanceMonth', 'div' => false,'class'=>'form-control','selected' => $ExpenseMaster['1'],'readonly'=>$readonly)); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->input('Vendor_State_Code',array('label' => false,'options'=>$StateCode,'class'=>'form-control','empty'=>'Select','value'=>$ExpenseEntryMaster[16],'id'=>'Vendor_State_Code','readonly'=>$readonly)); ?>
                </div>
                
                <label class="col-sm-2 control-label">Billing State Code</label>
                <div class="col-sm-4">
                    <?php echo $this->Form->input('Billing_State_Code',array('label' => false,'options'=>$StateCode,'class'=>'form-control','empty'=>'Select','value'=>$ExpenseEntryMaster[17],'id'=>'Billing_State_Code','readonly'=>$readonly)); ?>
                </div>
            </div>
    ...
    <div class="col-xs-12 col-sm-12">
		...
		<h4 class="page-header" style="border-bottom: 1px double #436e90;margin: 0 0 10px;">Details Entry</h4>
                    ...
                    <tr <?php foreach ($result as $post): $GTotal1 += $post['teep']['Total'];endforeach;  if(empty($ExpenseEntryMaster)) {  ?> style="display: none" <?php } else if($GTotal1==$ExpenseEntryMaster[7]) { ?> style="display: none" <?php } ?> >
                        ...
                        echo $this->Form->input('amount' ,array('label' =>false,'placeholder' => 'Amount','onBlur'=>"getTotalCostAmount('$gst_en')",'class' => 'form-control','onKeypress'=>'return isNumberKey(event)')); ?></th>
                        <th>
