    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php echo $this->Form->input('BranchName',array('label' => false,'options'=>$branchName,'empty'=>'Select','class'=>'form-control','id'=>'BranchName','onchange'=>'getBranch(this.value)','required'=>true)); ?>
            </div>    
        </div>
        ...
        <div class="col-sm-2">
            <div class="input-group">
                <?php echo $this->Form->input('CostCenter',array('label' => false,'options'=>'','empty'=>'Select','class'=>'form-control','id'=>'CostCenter','required'=>true)); ?>
            </div>    
        </div>
    </div>
