    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content box-con">
                ...
                <?php echo $this->Form->create('InterviewQuestions',array('action'=>'subjective_question','class'=>'form-horizontal','id'=>'form1')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="col-xs-12">
                            ...
                            <?php echo $this->Form->input('ques_paper_id',array('label' => false,'options'=>$paper_name,'empty'=>'Select','class'=>'form-control','id'=>'ques_paper_name','required'=>true,'onchange'=>"getQuestion(this.value,'Subjective')")); ?>
                        </div>
                        ...
                        <div class="col-xs-12" style="margin-top: 10px;">
                            <input type="submit"  value="Save" class="btn pull-right btn-primary btn-new" style='width: 100px;'>
                            <input onclick='return window.location="<?php echo $this->webroot;?>InterviewQuestions"' type="button" value="Back" class="btn btn-primary btn-new pull-left" style="margin-left: 5px;" />
                        </div>
                    </div>
