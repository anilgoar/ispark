...
function getPosition(name){ 
    ...
    $.post("<?php echo $this->webroot;?>InterviewQuestions/getposition",{name:name}, function(data){
        $("#position").html(data);
    });  
}
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    <span>Psychometric Test Report</span>
		</div>
		<div class="box-icons">
		...
		<div class="no-move"></div>
            ...
            <div class="box-content box-con">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <?php echo $this->Form->input('name',array('label' => false,'options'=>$interview_name,'empty'=>'Select','class'=>'form-control','id'=>'name','onchange'=>'getPosition(this.value)','required'=>true)); ?>
                    </div>
