...
mysql_query("UPDATE qual_employee SET DownloadCount='$DowCnt' WHERE EmpCode='{$_REQUEST['Empcode']}'");


$date1 = date("2017-07-01");
$date2 = $empArr['DOFJ'];
...
$html .=" 
        ...
        <table>
            <tr>
                <td style='width:400px;'><span style='font-weight:bold;font-size:18pt;font-family:Arial;'>Mas Callnet India Pvt. Ltd.</span><p style='font-size:11pt;font-family:Arial;' >(An ISO 9001 : 2008 Certified Company)</p></td>
        ...
        <div style='margin-top:40px;margin-left:20px;font-family:Trebuchet MS'>
            <p span style='font-weight:bold;font-size:8pt;' >To,</p>
            <div style='margin-top:20px;margin-left:20px;font-weight:bold;font-size:8pt;width:280px;'>
                <p>{$empArr['EmapName']}</p>
                <p>EMP Code - {$_REQUEST['Empcode']}</p>
               
            </div>
            
            <div style='margin-top:40px;font-family:Trebuchet MS'>
                <p span style='font-weight:bold;font-size:8pt;' >Date : <span>".date("d M Y")."</span></p>
                    <div >
                        <span style='font-weight:bold;font-size:8pt;' >Subject :</span>
        ...
        <div style='margin-top:10px;margin-left:30px;font-family:Trebuchet MS;font-size:8pt;'>
            <p span style='font-weight:bold;' >Dear {$empArr['EmapName']}</p>
            ...
            <p>1.1This appointment shall take effe	".date('d M Y', strtotime($newdate))."</p>
            <p style='font-weight:bold;margin-top:25px;'>2. DESIGNATION</p>
            <p>2.1 You will be designated as  '{$empArr['Desg']}' and you would be reporting to your Reporting Manager.</p>
            ...
            <div style='margin-left:50px;'>
                <table style='width:300px;'>
                    <tr><td>Basic Salary</td><td >Rs. {$empArr['Basic']}.00</td></tr>
                    <tr><td>House Rent Allowance</td><td >Rs. {$empArr['HRA']}.00</td></tr>
                    <tr><td>Conveyance  Allowance</td><td >Rs. {$empArr['Conv']}.00</td></tr>
                    <tr><td>Other Allowance</td><td >Rs. {$empArr['OthAllw']}.00</td></tr>
                    <tr><td>Gross Salary</td><td >Rs. {$empArr['Gross']}.00</td></tr>                
                    <tr><td>&nbsp;</td><td >&nbsp;</td></tr>
                    <tr><td>Deduction</td><td >Rs. {$empArr['TotalDed']}.00</td></tr>
                    <tr><td>ESIC</td><td >Rs. {$empArr['ESI']}.00</td></tr>
                    <tr><td>EPF</td><td >Rs. {$empArr['PF']}.00</td></tr>
                   <tr><td>&nbsp;</td><td >&nbsp;</td></tr>
                    <tr><td>Net Salary</td><td >Rs. {$empArr['Netpay']}.00</td></tr>
                    <tr><td>Employer Cont. - ESIC</td><td >Rs. {$empArr['EmplrESI']}.00</td></tr>
                    <tr><td>Employer Cont. - EPF</td><td >Rs. {$empArr['EmplrPF']}.00</td></tr>
                    <tr><td>Ins</td><td >Rs. {$empArr['EmplrIns']}.00</td></tr>
...
$html .="
        <div style='font-size:9pt;font-family:Trebuchet MS;word-spacing:4px;'>
...
$html .="
        <div style='font-size:9pt;font-family:Trebuchet MS;word-spacing:4px;height:800px;'>
...
$html .="
        ...
        <div style='font-size:9pt;font-family:Trebuchet MS;height:800px;'>
            ...
            <ol style='font-size:8pt;margin-top:25px;' >
            ...
            <ol style='font-size:8pt;margin-top:35px;' >
