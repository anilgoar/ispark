...
$password="vicidialnow"; // Mysql password 
...
$Month = $_GET['Month'];
$Year = $_GET['Year']; 
$empcode=$_GET['empCodes'];
$Mas = str_replace(",", "','", $empcode);
$newmascode="'".$Mas."'";
//echo $newmascode;die;
  $query =  "select qs.*,qa.Present,qa.WO,qa.Holiday from qual_salary qs left join qual_attendance qa on qs.EmpCode=qa.EmpCode and qs.SalMonth=qa.SalMonth and qs.SalYear=qa.SalYear  where qs.SalMonth = '$Month' and qs.SalYear = '$Year' and qs.EmpCode in ($newmascode) limit 20"; 
