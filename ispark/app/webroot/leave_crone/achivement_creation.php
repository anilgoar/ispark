...
// --------------- weitage approval --------------------
$qry ="SELECT * FROM `pli_weitage` WHERE mail_status='2'";
...
function send_mail($year,$month,$emp_code,$empname,$to,$con)
{
    ...
    $Subject        = "Achievement Created for $monthName $year"; 

    $EmailText      ="<div style='width:550px;height:auto;pxposition: relative;top:18;left:22px;'>";

    $EmailText     .= "<p>We are pleased to inform you that a new Achievement has been created for the month of $monthName $year,and it is named $empname.</p><p>Please review the details and let us know if you have any feedback or questions.</p>";
    ...
    if($done == '1')
    {
        ...
        $status .= 'Success';
        mysqli_query($con,"update pli_weitage SET mail_status=0 WHERE year='{$year}' and month='$month' and user_id='$emp_code' and mail_status='2'");
