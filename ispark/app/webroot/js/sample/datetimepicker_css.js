...
var imageFilesPath = "/ispark/app/webroot/js/sample/images/";
...
function RenderCssCal(bNewCal)
{
	...
	for (j = 1; j <= Cal.GetMonDays(); j += 1)
	{
		...
		if (DateBlockFlag=='' && DisableBeforeToday === true && (((j < (dtToday.getDate())-1) || (j > (dtToday.getDate()))) && (Cal.Month === dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Month < dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Year < dtToday.getFullYear())))
		{                    
		...
		{
			strCell = GenCell(j, false, DisableColor, false);//All Date is clickable
		}
