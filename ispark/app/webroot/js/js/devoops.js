	...
	function LoadDatatables(){
		$.getScript('dataTables.js', function(){
			$.getScript('ZeroClipboard.js', function(){
				$.getScript('TableTools.js', function(){
					$.getScript('dataTables.bootstrap.js', callback);
				});
			});
		});
	}
...
function TestTable2(){
	var asInitVals = [];
	var oTable = $('#datatable-2').dataTable2( {
		"aaSorting": [[ 0, "asc" ]],
		"sDom": "<'box-content'<'col-sm-6'f><'col-sm-6 text-right'l><'clearfix'>>rt<'box-content'<'col-sm-6'i><'col-sm-6 text-right'p><'clearfix'>>",
		"sPaginationType": "bootstrap",
		"oLanguage": {
...
$(document).ready(function () {
	...
	var height = window.innerHeight + 900;//alert(height);
